...
#define I2C3_IRQ  (BIA_IOAPIC_OFFSET + 14)
...
#define MPHY_HOP_OK_IRQ  (BIA_IOAPIC_OFFSET + 32)

#define GSP_MMU_IRQ (BIA_IOAPIC_OFFSET + 33)
#define VSP_MMU_IRQ (BIA_IOAPIC_OFFSET + 34)
#define ITHM1_ALERT_IRQ (BIA_IOAPIC_OFFSET + 35)
#define USB3_IRQ     (BIA_IOAPIC_OFFSET + 36)
#define DCAM2ISP_IF_IRQ (BIA_IOAPIC_OFFSET + 37)
...
#define UFS_IRQ       (BIA_IOAPIC_OFFSET + 44)
#define SPI3_IRQ      (BIA_IOAPIC_OFFSET + 45)
#define CE0_IRQ       (BIA_IOAPIC_OFFSET + 46)
#define CE1_IRQ       (BIA_IOAPIC_OFFSET + 47)
#define AGCP_MCDT_IRQ (BIA_IOAPIC_OFFSET + 48)
#define AGCP_DMA_IRQ  (BIA_IOAPIC_OFFSET + 49)
...
#define DISP_MMU_PF_IRQ (BIA_IOAPIC_OFFSET + 59)
#define CAM_MMU_PF_IRQ  (BIA_IOAPIC_OFFSET + 60)
...
#define CPP_MMU_PF_IRQ  (BIA_IOAPIC_OFFSET + 70)
...
#define GSP1_IRQ  (BIA_IOAPIC_OFFSET + 78)
#define GSP0_IRQ  (BIA_IOAPIC_OFFSET + 79)
#define DSI1_IRQ  (BIA_IOAPIC_OFFSET + 80)
/*NA 81*/
#define DSI0_IRQ  (BIA_IOAPIC_OFFSET + 82)
/*NA 83*/
#define DISPC1_IRQ (BIA_IOAPIC_OFFSET + 84)
#define DISPC0_IRQ (BIA_IOAPIC_OFFSET + 85)

#define PUB1_CTRL_IRQ   (BIA_IOAPIC_OFFSET + 86)
#define PUB1_AXI_BM_IRQ (BIA_IOAPIC_OFFSET + 87)
#define PUB1_DFI_BM_IRQ (BIA_IOAPIC_OFFSET + 88)
...
#define AGCP_WDG_RST_IRQ       (BIA_IOAPIC_OFFSET + 100)
#define WTLCP_TG_WDG_IRQ       (BIA_IOAPIC_OFFSET + 101)
#define AGCP_DMA_CHN1_GRP1_IRQ (BIA_IOAPIC_OFFSET + 102)
#define AGCP_DMA_CHN2_GRP1_IRQ (BIA_IOAPIC_OFFSET + 103)
#define AGCP_DMA_CHN1_GRP2_IRQ (BIA_IOAPIC_OFFSET + 104)
#define AGCP_DMA_CHN2_GRP2_IRQ (BIA_IOAPIC_OFFSET + 105)
#define WTLLCP_LTE_WDG_RST_IRQ (BIA_IOAPIC_OFFSET + 106)

#define NOC_ERR_IRQ          (BIA_IOAPIC_OFFSET + 107)
#define STATALARM_IRQ        (BIA_IOAPIC_OFFSET + 108)
...
#define PUB1_DFS_ERROR_IRQ   (BIA_IOAPIC_OFFSET + 117)
#define BIA_TMR_IRQ          (BIA_IOAPIC_OFFSET + 118)
#define VPP_DEINT_IRQ        (BIA_IOAPIC_OFFSET + 119)
#define DSI1_PLL_IRQ         (BIA_IOAPIC_OFFSET + 120)
...
#define GENERATION_PMU_IRQ   (BIA_IOAPIC_OFFSET + 124)
...
/* defines below are only for pass compile sc9853 */
#define MBOX_TAR_AP_NOWAKEUP_IRQ  (BIA_IOAPIC_OFFSET + 230)
#define ISP_MAIN_CH1_IRQ (BIA_IOAPIC_OFFSET + 230)
#define VBC_ADC23_IRQ (BIA_IOAPIC_OFFSET + 230)
#define VBC_ADC01_IRQ (BIA_IOAPIC_OFFSET + 230)
#define ISP_LITE_CH0_IRQ      (BIA_IOAPIC_OFFSET + 230)
#define DSIPLL_LOCK_STATUS_IRQ (BIA_IOAPIC_OFFSET + 230)
#define ISP_PERFMON_IRQ  (BIA_IOAPIC_OFFSET + 230)
#define CAM_IDI_SW_DONE_IRQ  (BIA_IOAPIC_OFFSET + 230)
#define ISP_LITE_CH1_IRQ  (BIA_IOAPIC_OFFSET + 230)
#define AON_DMA_CHN1_GRP1_SYNC_IRQ  (BIA_IOAPIC_OFFSET + 230)
#define AON_DMA_CHN2_GRP1_SYNC_IRQ  (BIA_IOAPIC_OFFSET + 230)
#define AON_DMA_CHN1_GRP2_SYNC_IRQ (BIA_IOAPIC_OFFSET + 230)
#define SEC_DMA_AON_IRQ   (BIA_IOAPIC_OFFSET + 230)
#define DMA_AON_IRQ (BIA_IOAPIC_OFFSET + 230)
#define AON_DMA_CHN2_GRP2_SYNC_IRQ (BIA_IOAPIC_OFFSET + 230)
#define MEM_FW_PUB0_IRQ (BIA_IOAPIC_OFFSET + 230)
#define MEM_FW_AP_PUB0_IRQ (BIA_IOAPIC_OFFSET + 230)
#define AP_FW_IRQ (BIA_IOAPIC_OFFSET + 230)
#define MEM_FW_AON_IRAM_IRQ (BIA_IOAPIC_OFFSET + 230)
#define SLV_FW_AON_IRQ          (BIA_IOAPIC_OFFSET + 230)
#define DSIPLL_UNLOCK_STATUS_IRQ        (BIA_IOAPIC_OFFSET + 230)
#define BIA_WDG_RESET_IRQ   (BIA_IOAPIC_OFFSET + 230)
#define ITHM0_OVERHEAT_IRQ        (BIA_IOAPIC_OFFSET + 230)
#define ITHM_ALERT_IRQ       (BIA_IOAPIC_OFFSET + 230)
