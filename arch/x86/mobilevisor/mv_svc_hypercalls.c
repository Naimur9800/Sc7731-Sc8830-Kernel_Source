...
void __weak mv_svc_pinctrl_init(void) {}
void __weak mv_svc_pm_init(void) {}
void __weak mv_svc_sys_exception_init(void) {}
void __weak mv_svc_coredump_init(void) {}
void __weak mv_svc_socwatch_init(void) {}
void __weak mv_svc_sep_init(void) {}
void __weak mv_svc_watchdog_init(void) {}
void __weak mv_svc_sysprof_init(void) {}
void __weak mv_svc_reg_access_init(void) {}
void __weak mv_svc_pmic_reg_access_init(void) {}
void __weak mv_svc_vtimer_init(void) {}
void __weak mv_svc_rtc_init(void) {}
void __weak mv_svc_spcu_thermal_init(void) {}
void __weak mv_svc_pwm_init(void) {}
void __weak mv_svc_security_init(void) {}
void __weak mv_svc_silent_lake_init(void) {}
void __weak mv_svc_log_init(void) {}
...
#ifdef __KERNEL__
EXPORT_SYMBOL(mv_svc_get_service_info);
#endif
