...
struct wake_lock mstar_irq_lock;
...
//    const char *vdd_name = "vdd";
	...
	wake_lock_init(&mstar_irq_lock, WAKE_LOCK_SUSPEND, "mstar_irq_lock");
...
static const struct of_device_id msg2xxx_of_match[] = {
       { .compatible = "msg2xxx,msg2233", },
       { }
};
...
static struct i2c_driver touch_device_driver =
{
    .driver	= {
		.name	= MSG_TP_IC_NAME,
		.owner	= THIS_MODULE,
		.of_match_table = msg2xxx_of_match,
	},
