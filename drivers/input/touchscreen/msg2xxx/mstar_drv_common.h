...
#define DEVICE_DRIVER_RELEASE_VERSION   ("2.1.1.0")
...
#if defined(CONFIG_DJT_PRJ_V173_WKT) || defined(CONFIG_DJT_PRJ_V210_CQS)
 ...
 * By default, this compile option is disabled.
 */
#if defined(CONFIG_CTP_GESTURE_SUPPORT)
#define CONFIG_ENABLE_GESTURE_WAKEUP
#endif
#if defined(CONFIG_CTP_RPOXIMITY_ENABLE)
...
#define CONFIG_CHIPTYPE_MSG2233       
