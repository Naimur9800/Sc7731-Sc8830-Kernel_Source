...
extern struct input_dev *proximity_input_dev_msg;
extern int is_incall;
extern struct class *firmware_class_msg;
extern struct device *firmware_cmd_dev_msg;

extern int mstar_prox_ctl(int value);
#endif
#ifdef WAKE_LOCK_LPSENSOR
extern struct wake_lock pls_delayed_work_wake_lock_msg;
#endif
...
#define FIRMWARE_FILE_PATH_ON_SD_CARD	  "/storage/sdcard0/msctp_update.bin"
#define FIRMWARE_FILE_PATH_ON_XR_T_CARD	  "/mnt/sdcard/msctp_update.bin"
...
#define MSG_TP_IC_NAME		"msg2138_ts" /* "msg21xxA" or "msg22xx" or "msg26xxM" msg2xxx */
