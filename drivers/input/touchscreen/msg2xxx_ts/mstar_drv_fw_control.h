 ...
 */
typedef enum {
	MSG28XX_SW_ID_XXXX = 0x0337,
	MSG28XX_SW_ID_YYYY = 0x0308, /* 0x0308 dj */
	/* MSG28XX_SW_ID_YYYY = 0x0308, //dj */
	/* MSG28XX_SW_ID_YYYY = 0x034A, //sk */
	/* MSG28XX_SW_ID_YYYY = 0x0337, //hf */
