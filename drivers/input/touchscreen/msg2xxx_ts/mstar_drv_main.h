...
#define PROC_NODE_XR_LIMIT_FIRMWARE_UPDATE	 "xr_limit_update"
...
extern ssize_t DrvMainProcfsXrLimitFirmwareUpdateRead(struct file *pFile, char __user *pBuffer, size_t nCount, loff_t *pPos);
