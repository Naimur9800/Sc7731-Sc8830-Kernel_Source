...
static u8 _gSelfICItoTestKeyNum;
static u8 _gSelfICItoTestDummyNum;
static u8 _gSelfICItoTestTriangleNum;
static u8 _gSelfICIsEnable2R;

static u8 *_gSelfIC_MAP1;
static u8 *_gSelfIC_MAP2;
static u8 *_gSelfIC_MAP3;
static u8 *_gSelfIC_MAP40_1;
static u8 *_gSelfIC_MAP40_2;
static u8 *_gSelfIC_MAP41_1;
static u8 *_gSelfIC_MAP41_2;

static u8 *_gSelfIC_SHORT_MAP1;
static u8 *_gSelfIC_SHORT_MAP2;
static u8 *_gSelfIC_SHORT_MAP3;

#ifdef CONFIG_ENABLE_MP_TEST_ITEM_FOR_2R_TRIANGLE
static u8 *_gSelfIC_MAP40_3;
static u8 *_gSelfIC_MAP40_4;
static u8 *_gSelfIC_MAP41_3;
static u8 *_gSelfIC_MAP41_4;

static u8 *_gSelfIC_SHORT_MAP4;
#endif /* CONFIG_ENABLE_MP_TEST_ITEM_FOR_2R_TRIANGLE */
...
static u16 *_gMsg21xxaOpen1;
static u16 *_gMsg21xxaOpen1B;
static u16 *_gMsg21xxaOpen2;
static u16 *_gMsg21xxaOpen2B;
static u16 *_gMsg21xxaOpen3;

/*  _gMsg21xxaShort_1~_gMsg21xxaShort_4 are for MSG21XXA */
static u16 *_gMsg21xxaShort_1;
static u16 *_gMsg21xxaShort_2;
static u16 *_gMsg21xxaShort_3;

/*  _gMsg21xxaShort_1_GPO~_gMsg21xxaShort_4_GPO are for MSG21XXA */
static u16 *_gMsg21xxaShort_1_GPO;
static u16 *_gMsg21xxaShort_2_GPO;
static u16 *_gMsg21xxaShort_3_GPO;

#ifdef CONFIG_ENABLE_MP_TEST_ITEM_FOR_2R_TRIANGLE
static u16 *_gMsg21xxaShort_4;
static u16 *_gMsg21xxaShort_4_GPO;
#endif /* CONFIG_ENABLE_MP_TEST_ITEM_FOR_2R_TRIANGLE */
#endif /* CONFIG_ENABLE_CHIP_TYPE_MSG21XXA */

#ifdef CONFIG_ENABLE_CHIP_TYPE_MSG22XX
static u8 _gIsOldFirmwareVersion;

/*  _gMsg22xxOpenRIU1~_gMsg22xxOpenRIU3 are for MSG22XX */
static u32 *_gMsg22xxOpenRIU1;
static u32 *_gMsg22xxOpenRIU2;
static u32 *_gMsg22xxOpenRIU3;

/*  _gMsg22xxShort_RIU1~_gMsg22xxShort_RIU4 are for MSG22XX */
static u32 *_gMsg22xxShort_RIU1;
static u32 *_gMsg22xxShort_RIU2;
static u32 *_gMsg22xxShort_RIU3;

/*  _gMsg22xxOpenSubFrameNum1~_gMsg22xxShortSubFrameNum4 are for MSG22XX */
static u8 _gMsg22xxOpenSubFrameNum1;
static u8 _gMsg22xxOpenSubFrameNum2;
static u8 _gMsg22xxOpenSubFrameNum3;
static u8 _gMsg22xxShortSubFrameNum1;
static u8 _gMsg22xxShortSubFrameNum2;
static u8 _gMsg22xxShortSubFrameNum3;

#ifdef CONFIG_ENABLE_MP_TEST_ITEM_FOR_2R_TRIANGLE
static u32 *_gMsg22xxShort_RIU4;
static u8 _gMsg22xxShortSubFrameNum4;
#endif /* CONFIG_ENABLE_MP_TEST_ITEM_FOR_2R_TRIANGLE */
#endif /* CONFIG_ENABLE_CHIP_TYPE_MSG22XX */
...
static u16 _gMutualICSenseLineNum;
static u16 _gMutualICDriveLineNum;
static u16 _gMutualICWaterProofNum;
...
static u8 _gMutualICTestSwitchMode;
...
static u16 _gMsg28xx_SENSE_NUM;
static u16 _gMsg28xx_DRIVE_NUM;
static u16 _gMsg28xx_KEY_NUM;
static u16 _gMsg28xx_KEY_LINE;
static u16 _gMsg28xx_GR_NUM;
static u16 _gMsg28xx_CSUB_REF;
static u16 _gMsg28xx_CFB_REF;
static u16 _gMsg28xx_SENSE_MUTUAL_SCAN_NUM;
static u16 _gMsg28xx_MUTUAL_KEY;
static u16 _gMsg28xx_PATTERN_TYPE;
static u16 _gMsg28xx_DC_RANGE;
static u16 _gMsg28xx_DC_RANGE_UP;
static u16 _gMsg28xx_DC_Ratio_1000;
static u16 _gMsg28xx_DC_Ratio_UP_1000;
static u16 _gMsg28xx_DC_Border_Ratio_1000;
static u16 _gMsg28xx_DC_Border_Ratio_UP_1000;
static u16 _gMsg28xx_PATTERN_MODEL;
static u16 _gMsg28xx_SENSOR_KEY_CH;
static s16 _gIcPinShortCheckFail;
static s16 _gItoShortCheckFail;

static u16 _gMsg28xx_SHORT_N1_TEST_NUMBER;
static u16 _gMsg28xx_SHORT_N2_TEST_NUMBER;
static u16 _gMsg28xx_SHORT_S1_TEST_NUMBER;
static u16 _gMsg28xx_SHORT_S2_TEST_NUMBER;
static u16 _gMsg28xx_SHORT_TEST_5_TYPE;
static u16 _gMsg28xx_SHORT_X_TEST_NUMBER;

static u16 *_gMsg28xx_SHORT_N1_TEST_PIN;
static u16 *_gMsg28xx_SHORT_N1_MUX_MEM_20_3E;
static u16 *_gMsg28xx_SHORT_N2_TEST_PIN;
static u16 *_gMsg28xx_SHORT_N2_MUX_MEM_20_3E;
static u16 *_gMsg28xx_SHORT_S1_TEST_PIN;
static u16 *_gMsg28xx_SHORT_S1_MUX_MEM_20_3E;
static u16 *_gMsg28xx_SHORT_S2_TEST_PIN;
static u16 *_gMsg28xx_SHORT_S2_MUX_MEM_20_3E;
static u16 *_gMsg28xx_SHORT_X_TEST_PIN;
static u16 *_gMsg28xx_SHORT_X_MUX_MEM_20_3E;
static u16 *_gMsg28xx_SHORT_GR_TEST_PIN;
static u16 *_gMsg28xx_SHORT_GR_MUX_MEM_20_3E;

static u16 *_gMsg28xx_SHORT_IcPIN_MUX_MEM_1_Settings;
static u16 *_gMsg28xx_SHORT_IcPIN_MUX_MEM_2_Settings;
static u16 *_gMsg28xx_SHORT_IcPIN_MUX_MEM_3_Settings;
static u16 *_gMsg28xx_SHORT_IcPIN_MUX_MEM_4_Settings;
static u16 *_gMsg28xx_SHORT_IcPIN_MUX_MEM_5_Settings;

static u16 *_gMsg28xx_PAD_TABLE_DRIVE;
static u16 *_gMsg28xx_PAD_TABLE_SENSE;
static u16 *_gMsg28xx_PAD_TABLE_GR;
static u16 *_gMsg28xx_SENSE_PAD_PIN_MAPPING;
static u8 *_gMsg28xx_KEYSEN;
static u8 *_gMsg28xx_KEYDRV;

static const u8 *_gMsg28xx_MapVaMutual;
static u8 *_gMsg28xx_AnaGen_Version;

static u16 _gMsg28xxTpType;
static s8 _gMsg28xxDeepStandBy;
static u16 _gMsg28xxDeepStandByTimeOut;
static u16 _gMsg28xx_SHORT_VALUE;
static u16 _gMsg28xx_ICPIN_SHORT;
static u16 _gMsg28xx_SupportIC;
static u16 _gMsg28xx_OPEN_MODE;
static u16 _gMsg28xx_CHARGE_PUMP;
static u16 _gMsg28xx_KEYDRV_O;
static u16 _gMsg28xx_SUB_FRAME;
static s32 _gMsg28xx_FIXED_CARRIER;
#endif /* CONFIG_ENABLE_CHIP_TYPE_MSG28XX */
...
static void _DrvMpTestItoTestMsg22xxRegisterResetPatch(void)
{
	...
	if (_gIsOldFirmwareVersion == 0) {
		/*  Only need to patch register reset for MSG22XX firmware older than V01.005.02; */
		return;
	}
...
static u16 _DrvMpTestItoTestSelfICChooseTpType(void)
{
	...
	for (i = 0; i < 10; i++) {
		...
		if (TP_TYPE_X == nTpType || TP_TYPE_Y == nTpType) {
			/*  Modify. */
			break;
		} else if (i < 5) {
			mdelay(100);
		...
		for (i = 0; i < _gMutualICSenseLineNum; i++) {
			...
			if (i > 0) {
				...
				if (nDelta > nPrev*MUTUAL_IC_FIR_RATIO/100) {
					if (0 == _gMutualICTestFailChannel[i * _gMutualICDriveLineNum + j]) {
						/*  for avoid _gTestFailChannelCount to be added twice */
						_gMutualICTestFailChannel[i * _gMutualICDriveLineNum + j] = 1;
						_gTestFailChannelCount++;
					}
					nRetVal = -1;
...
s32 _DrvMpTestMsg26xxmItoWaterProofTestEntry(void)
{
	...
	for (i = 0; i < 12; i++) {
		if (aResultTemp[i] < WATERPROOFVALUE) {
			/* change comparison way because float computing in driver is prohibited */
			_gMutualICTestFailChannel[i] = 1;
			_gTestFailChannelCount++;
			nRetVal = -1;
		} else {
...
static s32 _DrvMpTestItoTestMsg28xxGetDeltaC(s32 *pDeltaC)
{
	...
	for (i = 0; i < nSenNumBak; i++) {
		for (j = 0; j < nDrvNumBak; j++) {
			...
			if (nDrvPos >= _gMutualICDriveLineNum || nSenPos >= _gMutualICSenseLineNum)
				continue;
...
static s32 _DrvMpTestItoOpenTestMsg28xxOnCellOpenJudge(u16 nItemID, s8 pNormalTestResult[], u16 pNormalTestResultCheck[]/*, u16 nDriOpening*/)
{
	...
	if (_gMsg28xx_OPEN_MODE == 1) {
		/*  if open mode = 1 (sine mode), Csub must be zero. */
		nCSub = 0;
	}
...
static u16 _DrvMpTestMsg28xxItoTestChooseTpType(void)
{
	...
	for (i = 0; i < 10; i++) {
		...
		if (TP_TYPE_X == _gMsg28xxTpType || TP_TYPE_Y == _gMsg28xxTpType) {
			/*  Modify. */
			break;
		} else if (i < 5) {
			mdelay(100);
...
static s32 _DrvMpTestItoShortTestMsg28xxJudge(u8 nItemID, /*s8 pNormalTestResult[][2],*/ u16 pTestPinMap[][13], u16 *pTestPinCount)
{
   ...
   */
	...
	for (i = 0; i < *pTestPinCount; i++) {
		...
		if (0 == _DrvMpTestMutualICCheckValueInRange(_gMutualICResult[i + (nItemID - 1) * 13], MSG28XX_SHORT_VALUE, -1000))	{
			/* 0: false   1: true */
...
/* 			if (0 == _DrvMpTestMutualICCheckValueInRange(_gMutualICResult[i + (nItemID - 1) * 13], _gMsg28xx_SHORT_VALUE, -1000))	//0: false   1: true */
		if (0 == _DrvMpTestMutualICCheckValueInRange(_gMutualICResult[i + (nItemID - 1) * 13], _gMsg28xx_SHORT_VALUE, -_gMsg28xx_SHORT_VALUE)) {
			/* 0: false   1: true */
			/* pNormalTestResult[nItemID][0] = -1;	//-1: failed   0: success */
			/* 						 //0: golden   1: ratio */
			DBG(&g_I2cClient->dev, "*** Msg28xx Short Test# ShortTestMsg28xxJudge failed! ***\n");
	...
	for (i = 1; i < 6; i++) {
		...
		for (j = 0; j < 13; j++) {
			...
			if (((i-1) * 13 + j) < MUTUAL_IC_MAX_CHANNEL_NUM) {
				/*  prevent heap corruption detected */
...
_RETRY_SHORT:
	...
	for (i = 0; i < (_gMutualICSenseLineNum + _gMutualICDriveLineNum); i++) {
		if (aResultTemp[i] > MSG28XX_SHORT_VALUE) {
			/* change comparison way because float computing in driver is prohibited */
			_gMutualICTestFailChannel[i] = 1;
			_gTestFailChannelCount++;
			nRetVal = -1;
...
static s32 _DrvMpTestItoWaterProofTestMsg28xxTriggerWaterProofOneShot(s16 *pResultData, u32 nDelay)
{
	...
	} else if (_gMsg28xx_PATTERN_TYPE == 3 || _gMsg28xx_PATTERN_TYPE == 4) {
		/*  for open test */
		/* s16 nOpenResultData[nSF * nAfeOpening][nDriOpening]; */
...
static s32 _DrvMpTestMsg28xxItoWaterProofTestEntry(void)
{
	...
	for (i = 0; i < _gMutualICWaterProofNum; i++) {
		if (_gMutualICResultWater[i] > MSG28XX_WATER_VALUE)	{
			/* change comparison way because float computing in driver is prohibited */
			_gMutualICTestFailChannel[i] = 1;
			_gTestFailChannelCount++;
			nRetVal = -1;
