...
#else
extern int MsDrvInterfaceTouchDeviceResume(struct device *pSuspend);
extern int MsDrvInterfaceTouchDeviceSuspend(struct device *pSuspend);
#ifdef CONFIG_PM_SLEEP
extern int MsDrvInterfaceTouchDeviceAdfNotifierCallback(struct notifier_block *pSelf, unsigned long nEvent, void *pData);
#endif
#endif
