...
struct LITE_R3P0_GSP_CTL_REG_T {
	...
	struct LITE_R3P0_LAYERIMG_CLIP_START_REG  limg_clip_start[LITE_R3P0_IMGL_NUM];
	struct LITE_R3P0_LAYERIMG_CLIP_SIZE_REG  limg_clip_size[LITE_R3P0_IMGL_NUM];
	struct LITE_R3P0_LAYERIMG_DES_START_REG  limg_des_start[LITE_R3P0_IMGL_NUM];
	struct LITE_R3P0_LAYERIMG_PALLET_RGB_REG  limg_pallet_rgb[LITE_R3P0_IMGL_NUM];
	...
	struct LITE_R3P0_LAYERIMG_DES_SCL_SIZE_REG  limg_des_scl_size[LITE_R3P0_IMGL_NUM];
	...
	struct LITE_R3P0_LAYEROSD_CLIP_START_REG  losd_clip_start[LITE_R3P0_OSDL_NUM];
	struct LITE_R3P0_LAYEROSD_CLIP_SIZE_REG  losd_clip_size[LITE_R3P0_OSDL_NUM];
	struct LITE_R3P0_LAYEROSD_DES_START_REG  losd_des_start[LITE_R3P0_OSDL_NUM];
	struct LITE_R3P0_LAYEROSD_PALLET_RGB_REG  losd_pallet_rgb[LITE_R3P0_OSDL_NUM];
	...
	struct LITE_R3P0_LAYEROSD_R_ADDR_REG  osdsec_r_addr[LITE_R3P0_OSDSEC_NUM];
	struct LITE_R3P0_LAYEROSD_PITCH_REG  osdsec_pitch[LITE_R3P0_OSDSEC_NUM];
	struct LITE_R3P0_LAYEROSD_CLIP_START_REG  osdsec_clip_start[LITE_R3P0_OSDSEC_NUM];
	struct LITE_R3P0_LAYEROSD_CLIP_SIZE_REG  osdsec_clip_size[LITE_R3P0_OSDSEC_NUM];
	struct LITE_R3P0_LAYEROSD_DES_START_REG  osdsec_des_start[LITE_R3P0_OSDSEC_NUM];
	struct LITE_R3P0_LAYEROSD_PALLET_RGB_REG  osdsec_pallet_rgb[LITE_R3P0_OSDSEC_NUM];
