...
#define BIT_DAC0_FIFO_AE_LVL(x)    (((x)&0x1FF)<<16)
#define BIT_DAC0_FIFO_AF_LVL(x)    ((x)&0x1FF)

#define BIT_ADC0_FIFO_AE_LVL(x)    (((x)&0x1FF)<<16)
#define BIT_ADC0_FIFO_AF_LVL(x)    ((x)&0x1FF)

/*DMA channel sel for AP*/
#define BIT_MCDT_DAC_DMA_CH4_SEL0(x)    (((x)&0xF)<<16)
#define BIT_GET_MCDT_DAC_DMA_CH4_SEL0(x)    (((x)>>16)&0xF)
#define BIT_MCDT_DAC_DMA_CH3_SEL0(x)    (((x)&0xF)<<12)
#define BIT_GET_MCDT_DAC_DMA_CH3_SEL0(x)    (((x)>>12)&0xF)
#define BIT_MCDT_DAC_DMA_CH2_SEL0(x)    (((x)&0xF)<<8)
#define BIT_GET_MCDT_DAC_DMA_CH2_SEL0(x)    (((x)>>8)&0xF)
#define BIT_MCDT_DAC_DMA_CH1_SEL0(x)    (((x)&0xF)<<4)
#define BIT_GET_MCDT_DAC_DMA_CH1_SEL0(x)    (((x)>>4)&0xF)
#define BIT_MCDT_DAC_DMA_CH0_SEL0(x)    ((x)&0xF)
#define BIT_GET_MCDT_DAC_DMA_CH0_SEL0(x)    ((x)&0xF)

/*DMA channel sel for AP*/
#define BIT_MCDT_ADC_DMA_CH4_SEL0(x)    (((x)&0xF)<<16)
#define BIT_GET_MCDT_ADC_DMA_CH4_SEL0(x)    (((x)>>16)&0xF)
#define BIT_MCDT_ADC_DMA_CH3_SEL0(x)    (((x)&0xF)<<12)
#define BIT_GET_MCDT_ADC_DMA_CH3_SEL0(x)    (((x)>>12)&0xF)
#define BIT_MCDT_ADC_DMA_CH2_SEL0(x)    (((x)&0xF)<<8)
#define BIT_GET_MCDT_ADC_DMA_CH2_SEL0(x)    (((x)>>8)&0xF)
#define BIT_MCDT_ADC_DMA_CH1_SEL0(x)    (((x)&0xF)<<4)
#define BIT_GET_MCDT_ADC_DMA_CH1_SEL0(x)    (((x)>>4)&0xF)
#define BIT_MCDT_ADC_DMA_CH0_SEL0(x)    ((x)&0xF)
#define BIT_GET_MCDT_ADC_DMA_CH0_SEL0(x)    ((x)&0xF)
