...
struct isp_3dnr_const_param g_const_param_cap = {
	0, 1,
	5, 3, 3, 255, 255, 255,
	0, 255, 0, 255,
...
struct isp_3dnr_const_param g_const_param_pre = {
	0, 1,
	5, 3, 3, 255, 255, 255,
	0, 255, 0, 255,
...
int isp_k_cfg_3dnr_param(struct isp_io_param *param, enum isp_id idx)
{
	...
	case ISP_PRO_3DNR_UPDATE_CAP_PARAM:
		...
		break;
	default:
		pr_err("fail to get valid cmd id:%d\n", param->property);
		break;
	}
...
int isp_set_3dnr_common_reg(struct _3dnr_param *param)
{
...
int isp_generate_fmcu_cmd(struct _3dnr_param *param)
{
	unsigned int isp_reg = 0x60a00000;
...
int isp_generate_slice_param(struct _3dnr_param *param)
{
	unsigned int i, j;
...
int isp_generate_3dnr_slice_param(struct _3dnr_param *param)
{
	int slice_id, slice_num;
...
int isp_generate_3dnr_cmd_queue(struct _3dnr_param *param)
{
...
static void isp_reset_fmcu(struct _3dnr_param *param)
{
	unsigned int flag = 0;
	...
	flag = BIT(15);
	regmap_update_bits(param->cam_ahb_gpr,
...
int isp_start_fmcu(struct _3dnr_param *param)
{
	unsigned int isp_reg = param->isp_reg_base;

	isp_reset_fmcu(param);
...
int isp_3dnr_process_one_frame(struct isp_3dnr_info *param)
{
	...
	_param.cam_ahb_gpr = param->cam_ahb_gpr;
