...
static u8 g_ucFormat[SENSOR_TOTAL][V4L2_ISP_IMG3+1] = {
			     ...
			     u32 a_ud_buffer_addr_nv12uv_isp1)
{
	...
	if (a_uc_output_image <= V4L2_ISP_IMG3) {
		...
		if (g_ucFormat[a_uc_sensor][a_uc_output_image] ==
			...
			field_nv12_uv = g_output_field_table_nv12_uv
			[field_index];
			isp_set_field_value(field_nv12_uv
			, a_ud_buffer_addr_nv12uv);
