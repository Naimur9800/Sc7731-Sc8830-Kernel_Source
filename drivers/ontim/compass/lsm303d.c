...
#include <linux/i2c/compass/lsm303d.h>
/*#include "lsm303d.h"*/

//+add by hzb
#include <linux/ontim_dev_dgb.h>
static char gsensor_version[]="lsm303d_1.0";
static char gsensor_vendor_name[20]="lsm303d";
...
__ATTR(delay, 0664, attr_get_polling_rate_acc, attr_set_polling_rate_acc);
static struct kobj_attribute enable_attr_acc =
__ATTR(enable, 0664, attr_get_enable_acc, attr_set_enable_acc);
...
__ATTR(delay, 0664, attr_get_polling_rate_mag, attr_set_polling_rate_mag);
static struct kobj_attribute enable_attr_mag =
__ATTR(enable, 0664, attr_get_enable_mag, attr_set_enable_mag);
...
static ssize_t lsm303d_acc_vendor_name_show(struct kobject *kobj,
		struct kobj_attribute *attr, char *buf)
{
	 return sprintf(buf, "lsm303d-add\n");
}
static ssize_t lsm303d_mag_vendor_name_show(struct kobject *kobj,
		struct kobj_attribute *attr, char *buf)
{
	 return sprintf(buf, "lsm303d-mag\n");
}

static struct kobj_attribute acc_vendor_name =
__ATTR(vendor_name, 0664,lsm303d_acc_vendor_name_show, NULL);
static struct kobj_attribute mag_vendor_name =
__ATTR(vendor_name, 0664,lsm303d_mag_vendor_name_show, NULL);
...
#endif
	stat->input_dev_acc->name = "accelerometer";
