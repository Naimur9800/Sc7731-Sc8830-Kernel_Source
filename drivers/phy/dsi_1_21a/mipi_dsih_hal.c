 ...
 * @param instance pointer to structure holding the DSI Host core information
 * @param time taken to dpi interface signal delay
 */
...
#elif defined CONFIG_PHY_MEGACORE_SPRD
	mipi_dsih_write_part(instance, R_DSI_HOST_PHY_TMR_CFG,
					no_of_byte_cycles, 16, 16);
#else
	mipi_dsih_write_part(instance, R_DSI_HOST_PHY_TMR_CFG,
...
#elif defined CONFIG_PHY_INTEL_SPRD
		mipi_dsih_write_part(instance, R_DSI_HOST_PHY_TMR_RD_CFG,
