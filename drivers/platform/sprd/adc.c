...
static short adc_cali_data[4][2]
#if defined(CONFIG_ADC_DEBUG)
= {
	{4200, 3320},	/* same as nv adc_t */
	{3600, 2844},
	{900, 316},		/* 0.9@VBAT, Reserved IdealC Value */
	{300, 79}, 		/* 0.3@VBAT, Reserved IdealD Value */
}
#endif
;
...
static int __init adc_cali_fuse_proc(void)
{
	if (!is_valid_adc_cal()) {
	#if 0
		if (0 == sci_efuse_get_cal((u32 *) adc_cali_data, 2)) {
