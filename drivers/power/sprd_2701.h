...
struct sprd_2701_platform_data {
	uint16_t version;
	struct sprd_ext_ic_operations *sprd_2701_ops;
	int irq_gpio_number;
	int vbat_detect;
};
...
extern void sprd_2701_set_vindpm(unsigned char reg_val);
extern void sprd_2701_termina_cur_set(unsigned char reg_val);
extern void sprd_2701_termina_vol_set(unsigned char reg_val);
extern void sprd_2701_termina_time_set(unsigned char reg_val);
...
extern void sprd_2701_set_torch_brightness(unsigned char brightness);
extern void sprd_2701_stop_charging(unsigned int flag);
extern unsigned char sprd_2701_get_sys_status(void);
extern unsigned char sprd_2701_get_fault_val(void);
extern unsigned char sprd_2701_get_chgcur(void);
extern void sprd_2701_enable_chg(void);
extern void sprd_2701_set_chg_current_limit(uint32_t cur);
extern void sprd_2701_set_chg_current(unsigned char reg_val);
