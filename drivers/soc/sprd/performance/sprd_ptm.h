...
/* Definition for different boards compatibility. */
#ifndef REG_PUB_AHB_WRAP_BUSMON_CLK_EN
#define REG_PUB_AHB_WRAP_BUSMON_CLK_EN	0
#define BIT_PUB_AHB_WRAP_BUSMON_EB_REG	0
#define BIT_PUB_AHB_WRAP_BUSMON_EB_AXI	0
#endif
