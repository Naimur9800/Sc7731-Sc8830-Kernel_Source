...
extern void mptest_create_workqueue(void);
extern void mptest_get_datalog(enum ito_testmode_e e_ito_testmode,
	u8 *p_datalog, u32 *p_len);
extern void mptest_get_failchannel(enum ito_testmode_e e_ito_testmode,
					u8 *p_fail_channel,
					u32 *p_failchannel_count);
extern s32 mp_get_test_result(void);
extern void mptest_schedule_work(enum ito_testmode_e e_ito_testmode);
