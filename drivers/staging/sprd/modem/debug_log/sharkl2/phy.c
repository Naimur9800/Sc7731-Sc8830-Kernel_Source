...
#define REG_DBG_APB_TEST_CTRL			0x0000
#define REG_DBG_APB_TEST_DIN			0x0004
#define REG_DBG_APB_TEST_DOUT			0x0008
#define REG_DBG_APB_DBG_PHY_CTRL_0		0x000C
#define REG_DBG_APB_DBG_PHY_CTRL_5		0x0020
#define REG_DBG_APB_DBG_PHY_CTRL_RO_1		0x0028

/* REG_DBG_APB_TEST_CTRL */
#define BIT_DBG_APB_DBG_TESTEN			BIT(0)
#define BIT_DBG_APB_DBG_TESTCLR			BIT(1)
#define BIT_DBG_APB_DBG_TESTCLK			BIT(2)

/* REG_DBG_APB_DBG_PHY_CTRL_0 */
#define BIT_DBG_APB_RSTZ_DB			BIT(3)
#define BIT_DBG_APB_SHUTDOWN_DB			BIT(4)

/* REG_DBG_APB_DBG_PHY_CTRL_5 */
#define BIT_DBG_APB_ENABLECLK_DB		BIT(2)
#define BIT_DBG_APB_ENABLE_0_DB			BIT(3)
#define BIT_DBG_APB_ENABLE_1_DB			BIT(4)
#define BIT_DBG_APB_ENABLE_2_DB			BIT(5)
#define BIT_DBG_APB_ENABLE_3_DB			BIT(6)
...
static void dbg_phy_datalane_en(unsigned long base, int no)
{
	reg_bits_set(base + REG_DBG_APB_DBG_PHY_CTRL_5,
				...
				BIT_DBG_APB_ENABLE_2_DB |
				BIT_DBG_APB_ENABLE_3_DB);
}
...
static u8 dbg_phy_is_pll_locked(unsigned long base)
{
	...
	val = reg_read(base + REG_DBG_APB_DBG_PHY_CTRL_RO_1);

	return (val & BIT_DBG_APB_PLLLOCK_DB ? 1 : 0);
}
 ...
 */
#if 0
static u8 dbg_phy_test_dout(unsigned long base)
{
	return reg_read(base + REG_DBG_APB_TEST_DOUT);
}
#endif
...
#if 0
static u8 dbg_phy_test_read(unsigned long base, u8 address)
{
	dbg_phy_test_en(base, 1);
