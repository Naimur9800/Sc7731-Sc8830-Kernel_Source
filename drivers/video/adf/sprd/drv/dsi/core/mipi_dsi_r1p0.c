...
static struct ops_entry entry = {
	.ver = "sprd,mipi-dsi-r1p0",
	.ops = &mipi_dsi_r1p0_ops,
};
...
static struct ops_entry entry1 = {
	.ver = "sprd,dsi-ctrl-r1p0",
	.ops = &dsi_ctrl_r1p0_ops,
};

static int __init dsi_core_register(void)
{
	dsi_core_ops_register(&entry);
	dsi_core_ops_register(&entry1);
	return 0;
}
...
MODULE_DESCRIPTION("DSI Low-level registers operation for SPRD R1P0");
