...
int32_t s6d77a1a01_panel_after_suspend(struct panel_spec *self)
{
	return kpled_power_on(0);
}
int32_t s6d77a1a01_panel_before_resume(struct panel_spec *self)
{
...
static struct panel_operations lcd_s6d77a1a01_mipi_operations = {
	...
	.panel_after_suspend=s6d77a1a01_panel_after_suspend,
	.panel_before_resume=s6d77a1a01_panel_before_resume,
};
