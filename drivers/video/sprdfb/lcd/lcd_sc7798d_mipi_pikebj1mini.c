...
int32_t sc7798d_panel_after_suspend(struct panel_spec *self)
{
	return kpled_power_on(0);
}
int32_t sc7798d_panel_before_resume(struct panel_spec *self)
{
...
static struct panel_operations lcd_sc7798d_mipi_operations = {
	...
	.panel_after_suspend=sc7798d_panel_after_suspend,
	.panel_before_resume=sc7798d_panel_before_resume,
};
...
{
/*
	printk("sc7798d_mipi_init: set lcd backlight.\n");
