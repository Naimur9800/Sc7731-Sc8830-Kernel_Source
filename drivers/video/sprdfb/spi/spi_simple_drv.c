...
extern unsigned long REGS_SPI0_BASE;
extern unsigned long REGS_SPI1_BASE;
extern unsigned long REGS_SPI2_BASE;
...
#endif
{
	...
	switch (spi_id) {
	case 0:
		used_spi_reg_base = REGS_SPI0_BASE;
		break;
	case 1:
		used_spi_reg_base = REGS_SPI1_BASE;
		break;
	case 2:
		used_spi_reg_base = REGS_SPI2_BASE;
		break;
	default:
		BUG_ON(1);
	}
