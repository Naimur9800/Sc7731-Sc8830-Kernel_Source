...
#define SET16_A(p_dst, src)     do { *((UINT16 *)(p_dst)) = (UINT16)(src); } while (0)
#define SET32_A(p_dst, src)     do { *((UINT32 *)(p_dst)) = (UINT32)(src); } while (0)
#define SET64_A(p_dst, src)     do { *((UINT64 *)(p_dst)) = (UINT64)(src); } while (0)
#else
...
typedef struct {
	INT32	(*alloc_cluster)(struct super_block *sb,
	...
	INT32	(*init_dir_entry)(struct super_block *sb, CHAIN_T *p_dir,
			INT32 entry, UINT32 type, UINT32 start_clu,
			UINT64 size);
	INT32	(*init_ext_entry)(struct super_block *sb, CHAIN_T *p_dir,
			INT32 entry, INT32 num_entries, UNI_NAME_T *p_uniname,
			DOS_NAME_T *p_dosname);
	INT32	(*find_dir_entry)(struct super_block *sb, CHAIN_T *p_dir,
			UNI_NAME_T *p_uniname, INT32 num_entries,
			DOS_NAME_T *p_dosname, UINT32 type);
	void	(*delete_dir_entry)(struct super_block *sb, CHAIN_T *p_dir,
			INT32 entry, INT32 offset, INT32 num_entries);
	void	(*get_uni_name_from_ext_entry)(struct super_block *sb,
			CHAIN_T *p_dir, INT32 entry, UINT16 *uniname);
	INT32	(*count_ext_entries)(struct super_block *sb, CHAIN_T *p_dir,
...
INT32  fat_alloc_cluster(struct super_block *sb, INT32 num_alloc,
			CHAIN_T *p_chain);
INT32  exfat_alloc_cluster(struct super_block *sb,
			INT32 num_alloc, CHAIN_T *p_chain);
void   fat_free_cluster(struct super_block *sb,
			CHAIN_T *p_chain, INT32 do_relse);
...
void   exfat_chain_cont_cluster(struct super_block *sb,
			UINT32 chain, INT32 len);
...
INT32   fat_init_dir_entry(struct super_block *sb, CHAIN_T *p_dir,
				INT32 entry, UINT32 type,
				UINT32 start_clu, UINT64 size);
INT32   exfat_init_dir_entry(struct super_block *sb, CHAIN_T *p_dir,
				INT32 entry, UINT32 type,
				UINT32 start_clu, UINT64 size);
INT32   fat_init_ext_dir_entry(struct super_block *sb, CHAIN_T *p_dir,
				INT32 entry, INT32 num_entries,
				UNI_NAME_T *p_uniname, DOS_NAME_T *p_dosname);
INT32   exfat_init_ext_dir_entry(struct super_block *sb, CHAIN_T *p_dir,
				INT32 entry, INT32 num_entries,
				UNI_NAME_T *p_uniname, DOS_NAME_T *p_dosname);
...
void   fat_delete_dir_entry(struct super_block *sb, CHAIN_T *p_dir,
...
INT32  exfat_count_ext_entries(struct super_block *sb, CHAIN_T *p_dir,
				INT32 entry, DENTRY_T *p_entry);
INT32  count_dos_name_entries(struct super_block *sb,
				CHAIN_T *p_dir, UINT32 type);
...
INT32  resolve_path(struct inode *inode, UINT8 *path,
			CHAIN_T *p_dir, UNI_NAME_T *p_uniname);
...
INT32  create_dir(struct inode *inode, CHAIN_T *p_dir,
...
INT32  rename_file(struct inode *inode, CHAIN_T *p_dir, INT32 old_entry,
			UNI_NAME_T *p_uniname, FILE_ID_T *fid);
INT32  move_file(struct inode *inode, CHAIN_T *p_olddir, INT32 oldentry,
			CHAIN_T *p_newdir, UNI_NAME_T *p_uniname,
			FILE_ID_T *fid);
