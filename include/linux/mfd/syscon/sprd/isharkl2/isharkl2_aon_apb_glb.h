...
#define REG_AON_APB_VBC_CTRL                                 (0x32A0)
#define REG_AON_APB_ANA_BB_RESERVED                          (0x32A4)
#define REG_AON_APB_SP_BASE_ADDR                             (0x32A8)
#define REG_AON_APB_DGB_SERDES_CTRL                          (0x32AC)
#define REG_AON_APB_AP_VSP_MERGE_WRITE_DYN_QOS_CTRL_CFG      (0x3300)
#define REG_AON_APB_AP_VSP_MERGE_READ_DYN_QOS_CTRL_CFG       (0x3304)
#define REG_AON_APB_AP_VSP_MERGE_DYN_QOS_SEL                 (0x3308)
#define REG_AON_APB_BIA_WDG_RST_DELAY_CTRL                   (0x330C)
#define REG_AON_APB_WTL_GSM_TX                               (0x3310)
#define REG_AON_APB_BIA_PUB0_QOS                             (0x3314)
...
/* make it compatible with other chip definition */
#define BIT_AON_APB_SP_THM_OVERHEAT0_EN                                       BIT_AON_APB_ITHM1_BIA_OVERHEAT_RST_EN
