...
#define REG_COM_PMU_APB_SYS_SOFT_RESET                   (0x0000)
#define REG_COM_PMU_APB_USB_PMU_CTRL                     (0x0004)
#define REG_COM_PMU_APB_DDR_SLEEP_CTRL                   (0x0008)
#define REG_COM_PMU_APB_MEM_SLP_CFG0                     (0x000C)
#define REG_COM_PMU_APB_MEM_SD_CFG0                      (0x0010)
#define REG_COM_PMU_APB_MEM_AUTO_SLP_EN                  (0x0014)
#define REG_COM_PMU_APB_MEM_AUTO_SD_EN                   (0x0018)
#define REG_COM_PMU_APB_PAD_OUT_CHIP_SLEEP_CTRL          (0x001C)
#define REG_COM_PMU_APB_PAD_OUT_XTL_EB_CTRL              (0x0020)
#define REG_COM_PMU_APB_PAD_OUT_XTL_EB1_CTRL             (0x0024)
#define REG_COM_PMU_APB_PAD_OUT_XTL_EB2_CTRL             (0x0028)
#define REG_COM_PMU_APB_DCXO_LC_DEEP_SLEEP_CTRL          (0x002C)
#define REG_COM_PMU_APB_PAD_OUT_DCDCCPU_EB_CTRL          (0x0030)
#define REG_COM_PMU_APB_PAD_CFG_EN_ANLGMODE              (0x0034)
#define REG_COM_PMU_APB_DDR_PHY_DATA_RET_CTRL            (0x0048)
#define REG_COM_PMU_APB_EXT_XTL_COMB_EN                  (0x004C)
#define REG_COM_PMU_APB_LVDS_RF_PLL_REF_SEL              (0x0050)
#define REG_COM_PMU_APB_SYS_FRC_SLEEP_REQ                (0x0054)
#define REG_COM_PMU_APB_SYS_FRC_SLEEP_ACK                (0x0058)
#define REG_COM_PMU_APB_EFUSE_START_CFG                  (0x005C)
#define REG_COM_PMU_APB_FRC_SLEEP_ACK_BYP                (0x0060)
#define REG_COM_PMU_APB_FRC_SLEEP_REQ_CNT                (0x0064)
#define REG_COM_PMU_APB_LDO_PWR_CTRL0                    (0x0068)
#define REG_COM_PMU_APB_LDO_PWR_CTRL1                    (0x006C)
#define REG_COM_PMU_APB_AON_PUB_FRC_SLP_CTRL             (0x0070)
#define REG_COM_PMU_APB_PD_EXT_DOMAIN_ACK                (0x0074)
#define REG_COM_PMU_APB_UFS_LP_PWR_GATE_REQ_BYP          (0x0078)
#define REG_COM_PMU_APB_USB2PHY_PS_CTRL                  (0x007C)
#define REG_COM_PMU_APB_USB2PHY_PS_REG_CTRL              (0x0080)
#define REG_COM_PMU_APB_USB3PHY_DISCONNECT_CTRL          (0x0084)
#define REG_COM_PMU_APB_USB3PHY_DISCONNECT_REG_CTRL      (0x0088)
#define REG_COM_PMU_APB_DDR0_CHN_SLEEP_CTRL              (0x008C)
#define REG_COM_PMU_APB_DDR1_CHN_SLEEP_CTRL              (0x0090)
#define REG_COM_PMU_APB_AON_RAM_SLEEP_CTRL               (0x0094)
#define REG_COM_PMU_APB_PUB_MEM_RESET_RET                (0x0098)
#define REG_COM_PMU_APB_BIA_VDD_L2_SRAM_CTRL             (0x009C)
#define REG_COM_PMU_APB_EFUSE_LDO_CTRL                   (0x00A0)
#define REG_COM_PMU_APB_EFUSE_LDO_DBG                    (0x00A4)
#define REG_COM_PMU_APB_MPLL0_LP_CTRL0                   (0x00B0)
#define REG_COM_PMU_APB_MPLL0_LP_CTRL1                   (0x00B4)
#define REG_COM_PMU_APB_MPLL1_LP_CTRL0                   (0x00B8)
#define REG_COM_PMU_APB_MPLL1_LP_CTRL1                   (0x00BC)
#define REG_COM_PMU_APB_MPLL2_LP_CTRL0                   (0x00C0)
#define REG_COM_PMU_APB_MPLL2_LP_CTRL1                   (0x00C4)
#define REG_COM_PMU_APB_INT_REQ_PWR_CHG_CLR              (0x00C8)
#define REG_COM_PMU_APB_MBOX_NOPWR_DOWN_BYP              (0x00CC)
#define REG_COM_PMU_APB_FENCING_LOCK_BYP                 (0x00D0)
#define REG_COM_PMU_APB_FENCING0_CTRL_STATE              (0x00D4)
#define REG_COM_PMU_APB_FENCING1_CTRL_STATE              (0x00D8)
#define REG_COM_PMU_APB_EFUSE_LDO_DLY0                   (0x00DC)
#define REG_COM_PMU_APB_EFUSE_LDO_DLY1                   (0x00E0)
#define REG_COM_PMU_APB_EFUSE_LDO_DLY2                   (0x00E4)
#define REG_COM_PMU_APB_EFUSE_LDO_DLY3                   (0x00E8)
#define REG_COM_PMU_APB_EFUSE_LDO_DLY4                   (0x00EC)
#define REG_COM_PMU_APB_EFUSE_LDO_DLY5                   (0x00F0)
#define REG_COM_PMU_APB_EFUSE_LDO_DLY6                   (0x00F4)
#define REG_COM_PMU_APB_EFUSE_LDO_DLY7                   (0x00F8)
#define REG_COM_PMU_APB_AXI_LPC_CTRL_DISABLE             (0x00FC)
#define REG_COM_PMU_APB_AUD_DMA_BUSY_SLP_EN              (0x0100)
#define REG_COM_PMU_APB_AUD_SYS_SLP_EN                   (0x0104)
#define REG_COM_PMU_APB_DDR0_LP_MASK                     (0x0108)
#define REG_COM_PMU_APB_DSPLL_LP_CTRL0                   (0x010C)
#define REG_COM_PMU_APB_DSPLL_LP_CTRL1                   (0x0110)
#define REG_COM_PMU_APB_GPU_CORE_FORCE                   (0x0114)
#define REG_COM_PMU_APB_INT_REQ_PWR_ON_CFG               (0x0118)
#define REG_COM_PMU_APB_SMART_LSLP_ENA                   (0x011C)
#define REG_COM_PMU_APB_FENCING_LOCK_WAIT_NUM0           (0x0200)
#define REG_COM_PMU_APB_FENCING_LOCK_WAIT_NUM1           (0x0204)
#define REG_COM_PMU_APB_FENCING_LOCK_WAIT_NUM2           (0x0208)
#define REG_COM_PMU_APB_SP_PUB_ACCESS_EN                 (0x020C)
#define REG_COM_PMU_APB_DDR_SLEEP_CNT                    (0x0210)
#define REG_COM_PMU_APB_DDR_SLEEP_CNT_CFG                (0x0214)
#define REG_COM_PMU_APB_PMU_ENHANCE_EN                   (0x0218)
#define REG_COM_PMU_APB_PLL_STATUS_MASK                  (0x021C)
#define REG_COM_PMU_APB_PMU_DEBUG_CFG                    (0x0220)
#define REG_COM_PMU_APB_PMU_DEBUG_BUS                    (0x0224)
