...
#define REG_PMU_APB_PD_TOP_PWR_CFG                             (0x0018)
#define REG_PMU_APB_PD_AON_SYS_PWR_CFG                         (0x001C)
#define REG_PMU_APB_PD_PUBCP_SYS_PWR_CFG                       (0x0020)
#define REG_PMU_APB_PD_AGCP_SYS_PWR_CFG                        (0x0024)
#define REG_PMU_APB_PD_WTLCP_LTE_P4_PWR_CFG                    (0x0028)
#define REG_PMU_APB_PD_WTLCP_TGDSP_PWR_CFG                     (0x002C)
#define REG_PMU_APB_PD_WTLCP_HU3GE_B_PWR_CFG                   (0x0030)
#define REG_PMU_APB_PD_AP_SYS_PWR_CFG                          (0x0034)
#define REG_PMU_APB_PD_GPU_PHANTOM_PWR_CFG1                    (0x0038)
#define REG_PMU_APB_PD_GPU_PHANTOM_PWR_CFG0                    (0x003C)
#define REG_PMU_APB_PD_AGCP_DSP_PWR_CFG                        (0x0040)
#define REG_PMU_APB_PD_PUB0_SYS_PWR_CFG                        (0x0044)
#define REG_PMU_APB_PD_WTLCP_LTE_P1_PWR_CFG                    (0x0048)
#define REG_PMU_APB_PD_VSP_SYS_PWR_CFG                         (0x004C)
#define REG_PMU_APB_PD_WTLCP_LDSP_PWR_CFG                      (0x0050)
#define REG_PMU_APB_PD_GPU_TOP_PWR_CFG1                        (0x0054)
#define REG_PMU_APB_PD_GPU_TOP_PWR_CFG0                        (0x0058)
#define REG_PMU_APB_PD_PUB1_SYS_PWR_CFG                        (0x005C)
#define REG_PMU_APB_PD_WTLCP_TD_PWR_CFG                        (0x0060)
#define REG_PMU_APB_PD_BIA_PWR_CFG0                            (0x0064)
#define REG_PMU_APB_PD_BIA_PWR_CFG1                            (0x0068)
#define REG_PMU_APB_PD_BIA_PWR_CFG2                            (0x006C)
#define REG_PMU_APB_PD_BIA_PWR_CFG3                            (0x0070)
#define REG_PMU_APB_PD_BIA_PWR_CFG4                            (0x0074)
#define REG_PMU_APB_PD_BIA_PWR_CFG5                            (0x0078)
#define REG_PMU_APB_PD_BIA_PWR_CFG6                            (0x007C)
#define REG_PMU_APB_PD_WTLCP_LTE_P3_PWR_CFG                    (0x0080)
#define REG_PMU_APB_PD_WTLCP_SYS_PWR_CFG                       (0x0084)
#define REG_PMU_APB_PD_ISP_TOP_PWR_CFG                         (0x0088)
#define REG_PMU_APB_PD_WTLCP_LTE_P2_PWR_CFG                    (0x008C)
#define REG_PMU_APB_PD_VSP_CORE_PWR_CFG                        (0x0090)
#define REG_PMU_APB_PD_CAM_SYS_PWR_CFG                         (0x0094)
#define REG_PMU_APB_PD_WTLCP_HU3GE_A_PWR_CFG                   (0x0098)
#define REG_PMU_APB_XTL_WAIT_CNT0                              (0x00AC)
#define REG_PMU_APB_XTLBUF_WAIT_CNT0                           (0x00BC)
#define REG_PMU_APB_PLL_WAIT_CNT1                              (0x00C0)
#define REG_PMU_APB_PLL_WAIT_CNT2                              (0x00C4)
#define REG_PMU_APB_PLL_WAIT_CNT3                              (0x00C8)
#define REG_PMU_APB_GPLL_REL_CFG                               (0x00CC)
#define REG_PMU_APB_DPLL1_REL_CFG                              (0x00D0)
#define REG_PMU_APB_XTLBUF2_REL_CFG                            (0x00D4)
#define REG_PMU_APB_DPLL0_REL_CFG                              (0x00D8)
#define REG_PMU_APB_MPLL0_REL_CFG                              (0x00DC)
#define REG_PMU_APB_XTLBUF1_REL_CFG                            (0x00E0)
#define REG_PMU_APB_RPLL1_REL_CFG                              (0x00E4)
#define REG_PMU_APB_DSPLL_REL_CFG                              (0x00E8)
#define REG_PMU_APB_XTLBUF0_REL_CFG                            (0x00EC)
#define REG_PMU_APB_MPLL1_REL_CFG                              (0x00F0)
#define REG_PMU_APB_MPLL2_REL_CFG                              (0x00F4)
#define REG_PMU_APB_TWPLL_REL_CFG                              (0x00F8)
#define REG_PMU_APB_ISPPLL_REL_CFG                             (0x00FC)
#define REG_PMU_APB_RC_REL_CFG                                 (0x0100)
#define REG_PMU_APB_LPLL0_REL_CFG                              (0x0104)
#define REG_PMU_APB_XTL0_REL_CFG                               (0x0108)
#define REG_PMU_APB_RPLL0_REL_CFG                              (0x010C)
#define REG_PMU_APB_PWR_STATE_DBG1                             (0x011C)
#define REG_PMU_APB_PWR_STATE_DBG2                             (0x0120)
#define REG_PMU_APB_PWR_STATE_DBG3                             (0x0124)
#define REG_PMU_APB_PWR_STATE_DBG4                             (0x0128)
#define REG_PMU_APB_PUB0_SYS_SLEEP_CTRL                        (0x012C)
#define REG_PMU_APB_PUB1_SYS_SLEEP_CTRL                        (0x0130)
#define REG_PMU_APB_AP_SYS_SLEEP_CTRL                          (0x0134)
#define REG_PMU_APB_CM4_SYS_SLEEP_CTRL                         (0x0138)
#define REG_PMU_APB_WTLCP_SYS_SLEEP_CTRL                       (0x0144)
#define REG_PMU_APB_AGCP_SYS_SLEEP_CTRL                        (0x0148)
#define REG_PMU_APB_PUBCP_SYS_SLEEP_CTRL                       (0x014C)
#define REG_PMU_APB_SYS_SLP_STATUS0                            (0x015C)
#define REG_PMU_APB_BISR_DONE_STATUS0                          (0x0160)
#define REG_PMU_APB_BISR_BUSY_STATUS0                          (0x0170)
#define REG_PMU_APB_BISR_BYP_CFG0                              (0x0178)
#define REG_PMU_APB_BISR_FORCE_EN_CFG0                         (0x0180)
#define REG_PMU_APB_SLEEP_XTL_ON_CTRL0                         (0x0184)
#define REG_PMU_APB_PWR_WAIT_CNT_CFG1                          (0x018C)
#define REG_PMU_APB_PWR_WAIT_CNT_CFG0                          (0x0190)
#define REG_PMU_APB_PWR_PD_WAIT_CNT_CFG1                       (0x0198)
#define REG_PMU_APB_PWR_PD_WAIT_CNT_CFG0                       (0x019C)
#define REG_PMU_APB_PD_PUBCP_SYS_CORE_INT_DISABLE              (0x01A4)
#define REG_PMU_APB_PD_WTLCP_TGDSP_CORE_INT_DISABLE            (0x01A8)
#define REG_PMU_APB_PD_AGCP_DSP_CORE_INT_DISABLE               (0x01AC)
#define REG_PMU_APB_PD_WTLCP_LDSP_CORE_INT_DISABLE             (0x01B0)
#define REG_PMU_APB_PD_BIA_CORE_INT_DISABLE                    (0x01B4)
#define REG_PMU_APB_AP_SYS_DSLP_ENA                            (0x01C4)
#define REG_PMU_APB_CM4_SYS_DSLP_ENA                           (0x01C8)
#define REG_PMU_APB_WTLCP_SYS_DSLP_ENA                         (0x01CC)
#define REG_PMU_APB_AGCP_SYS_DSLP_ENA                          (0x01D0)
#define REG_PMU_APB_PUBCP_SYS_DSLP_ENA                         (0x01D4)
#define REG_PMU_APB_PD_WTLCP_TGDSP_DSLP_ENA                    (0x01E4)
#define REG_PMU_APB_PD_AGCP_DSP_DSLP_ENA                       (0x01E8)
#define REG_PMU_APB_PD_WTLCP_LDSP_DSLP_ENA                     (0x01EC)
#define REG_PMU_APB_PD_BIA_DSLP_ENA                            (0x01F0)
#define REG_PMU_APB_PWR_ST_DBG_DLY0                            (0x01F4)
#define REG_PMU_APB_PWR_ST_DBG_DLY1                            (0x01F8)
#define REG_PMU_APB_PWR_ST_DBG_DLY2                            (0x01FC)
#define REG_PMU_APB_LIGHT_SLEEP_ENABLE0                        (0x0204)
#define REG_PMU_APB_PUB_DEEP_SLEEP_ENABLE0                     (0x0208)
#define REG_PMU_APB_DOZE_SLEEP_ENABLE0                         (0x0214)
#define REG_PMU_APB_PLL_CNT_DONE_STATUS0                       (0x021C)
#define REG_PMU_APB_POWER_SWITCH_ACK_D_STATUS0                 (0x0224)
#define REG_PMU_APB_POWER_SWITCH_ACK_M_STATUS0                 (0x022C)
#define REG_PMU_APB_CGM_PMU_SEL_CFG                            (0x0234)
#define REG_PMU_APB_WTLCP_TGDSP_WAKEUP_SOURCE_EN0              (0x0238)
#define REG_PMU_APB_AGCP_DSP_WAKEUP_SOURCE_EN0                 (0x023C)
#define REG_PMU_APB_WTLCP_LDSP_WAKEUP_SOURCE_EN0               (0x0240)
#define REG_PMU_APB_WTLCP_SYS_WAKEUP_SOURCE_EN0                (0x0244)
#define REG_PMU_APB_CM4_SYS_WAKEUP_SOURCE_EN0                  (0x0248)
#define REG_PMU_APB_CM4_SYS_WAKEUP_SOURCE_EN1                  (0x024C)
#define REG_PMU_APB_PUBCP_CR5_WAKEUP_SOURCE_EN0                (0x0250)
#define REG_PMU_APB_BASEIA_WAKEUP_SOURCE_EN0                   (0x0254)
#define REG_PMU_APB_BASEIA_WAKEUP_SOURCE_EN1                   (0x0258)
#define REG_PMU_APB_BASEIA_WAKEUP_SOURCE_EN2                   (0x025C)
#define REG_PMU_APB_BASEIA_WAKEUP_SOURCE_EN3                   (0x0260)
#define REG_PMU_APB_PD_PUBCP_SYS_SHUTDOWN_MARK_STATUS          (0x0268)
#define REG_PMU_APB_PD_AGCP_SYS_SHUTDOWN_MARK_STATUS           (0x026C)
#define REG_PMU_APB_PD_WTLCP_LTE_P4_SHUTDOWN_MARK_STATUS       (0x0270)
#define REG_PMU_APB_PD_WTLCP_TGDSP_SHUTDOWN_MARK_STATUS        (0x0274)
#define REG_PMU_APB_PD_TOP_SHUTDOWN_MARK_STATUS                (0x0278)
#define REG_PMU_APB_PD_WTLCP_HU3GE_B_SHUTDOWN_MARK_STATUS      (0x027C)
#define REG_PMU_APB_PD_AP_SYS_SHUTDOWN_MARK_STATUS             (0x0280)
#define REG_PMU_APB_PD_GPU_PHANTOM_SHUTDOWN_MARK_STATUS        (0x0284)
#define REG_PMU_APB_PD_AGCP_DSP_SHUTDOWN_MARK_STATUS           (0x0288)
#define REG_PMU_APB_PD_PUB0_SYS_SHUTDOWN_MARK_STATUS           (0x028C)
#define REG_PMU_APB_PD_WTLCP_LTE_P1_SHUTDOWN_MARK_STATUS       (0x0290)
#define REG_PMU_APB_PD_VSP_SYS_SHUTDOWN_MARK_STATUS            (0x0294)
#define REG_PMU_APB_PD_WTLCP_LDSP_SHUTDOWN_MARK_STATUS         (0x0298)
#define REG_PMU_APB_PD_GPU_TOP_SHUTDOWN_MARK_STATUS            (0x029C)
#define REG_PMU_APB_PD_PUB1_SYS_SHUTDOWN_MARK_STATUS           (0x02A0)
#define REG_PMU_APB_PD_WTLCP_TD_SHUTDOWN_MARK_STATUS           (0x02A4)
#define REG_PMU_APB_PD_BIA_SHUTDOWN_MARK_STATUS                (0x02A8)
#define REG_PMU_APB_PD_WTLCP_LTE_P3_SHUTDOWN_MARK_STATUS       (0x02AC)
#define REG_PMU_APB_PD_WTLCP_SYS_SHUTDOWN_MARK_STATUS          (0x02B0)
#define REG_PMU_APB_PD_ISP_TOP_SHUTDOWN_MARK_STATUS            (0x02B4)
#define REG_PMU_APB_PD_WTLCP_LTE_P2_SHUTDOWN_MARK_STATUS       (0x02B8)
#define REG_PMU_APB_PD_VSP_CORE_SHUTDOWN_MARK_STATUS           (0x02BC)
#define REG_PMU_APB_PD_CAM_SYS_SHUTDOWN_MARK_STATUS            (0x02C0)
#define REG_PMU_APB_PD_WTLCP_HU3GE_A_SHUTDOWN_MARK_STATUS      (0x02C4)
#define REG_PMU_APB_DDR0_ACC_RDY                               (0x02CC)
#define REG_PMU_APB_DDR0_LIGHT_ACC_RDY                         (0x02D0)
#define REG_PMU_APB_DDR0_SLP_CFG                               (0x02D4)
#define REG_PMU_APB_DDR1_ACC_RDY                               (0x02D8)
#define REG_PMU_APB_DDR1_LIGHT_ACC_RDY                         (0x02DC)
#define REG_PMU_APB_DDR1_SLP_CFG                               (0x02E0)
#define REG_PMU_APB_PD_CM4_CORE_INT_DISABLE                    (0x02E4)
...
#define BIT_PMU_APB_RESERVD                                                             BIT(9)
