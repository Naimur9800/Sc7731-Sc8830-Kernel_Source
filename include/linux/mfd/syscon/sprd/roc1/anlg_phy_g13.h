...
#define BIT_ANLG_PHY_G13_ANALOG_PCIEPLL_H_RG_PCIEPLLH_REFCK_SEL(x)          (((x) & 0x7) << 28)
#define BIT_ANLG_PHY_G13_ANALOG_PCIEPLL_H_RG_PCIEPLLH_CLKOUTEXT_EN          BIT(27)
#define BIT_ANLG_PHY_G13_ANALOG_PCIEPLL_H_RG_PCIEPLLH_PD                    BIT(26)
#define BIT_ANLG_PHY_G13_ANALOG_PCIEPLL_H_RG_PCIEPLLH_RST                   BIT(25)
#define BIT_ANLG_PHY_G13_ANALOG_PCIEPLL_H_RG_PCIEPLLH_N(x)                  (((x) & 0x7FF) << 14)
#define BIT_ANLG_PHY_G13_ANALOG_PCIEPLL_H_RG_PCIEPLLH_CLKOUTEN              BIT(13)
#define BIT_ANLG_PHY_G13_ANALOG_PCIEPLL_H_RG_PCIEPLLH_DIVN(x)               (((x) & 0x1F) << 8)
#define BIT_ANLG_PHY_G13_ANALOG_PCIEPLL_H_RG_PCIEPLLH_BIST_CTRL(x)          (((x) & 0xFF))
...
#define BIT_ANLG_PHY_G13_DBG_SEL_ANALOG_PCIEPLL_H_RG_PCIEPLLH_CLKOUTEXT_EN  BIT(4)
