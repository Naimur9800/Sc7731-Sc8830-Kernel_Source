...
#define REG_ANLG_PHY_G2_ANALOG_MIPI_DSI_4LANE_DSI_4L_RSVD               (0x0024)
...
#define REG_ANLG_PHY_G2_ANALOG_MIPI_DSI_4LANE_DSI_DUMY_CTRL             (0x0030)
#define REG_ANLG_PHY_G2_ANALOG_MIPI_DSI_4LANE_MIPI_CTRL7                (0x0034)
#define REG_ANLG_PHY_G2_ANALOG_MIPI_DSI_4LANE_REG_SEL_CFG_0             (0x0038)
#define REG_ANLG_PHY_G2_ANALOG_MIPI_DSI_4LANE_REG_SEL_CFG_1             (0x003C)
...
#define BIT_ANLG_PHY_G2_ANALOG_MIPI_DSI_4LANE_DSI_RXLPDTESC_0                BIT(23)
#define BIT_ANLG_PHY_G2_ANALOG_MIPI_DSI_4LANE_DSI_RXTRIGGERESC_0(x)          (((x) & 0xF) << 19)
#define BIT_ANLG_PHY_G2_ANALOG_MIPI_DSI_4LANE_DSI_RXVALIDESC_0               BIT(18)
#define BIT_ANLG_PHY_G2_ANALOG_MIPI_DSI_4LANE_DSI_RXLPDTESC_1                BIT(17)
#define BIT_ANLG_PHY_G2_ANALOG_MIPI_DSI_4LANE_DSI_RXTRIGGERESC_1(x)          (((x) & 0xF) << 13)
#define BIT_ANLG_PHY_G2_ANALOG_MIPI_DSI_4LANE_DSI_RXVALIDESC_1               BIT(12)
#define BIT_ANLG_PHY_G2_ANALOG_MIPI_DSI_4LANE_DSI_RXLPDTESC_2                BIT(11)
#define BIT_ANLG_PHY_G2_ANALOG_MIPI_DSI_4LANE_DSI_RXTRIGGERESC_2(x)          (((x) & 0xF) << 7)
#define BIT_ANLG_PHY_G2_ANALOG_MIPI_DSI_4LANE_DSI_RXVALIDESC_2               BIT(6)
...
/* REG_ANLG_PHY_G2_ANALOG_MIPI_DSI_4LANE_DSI_4L_RSVD */

#define BIT_ANLG_PHY_G2_ANALOG_MIPI_DSI_4LANE_DSI_RESERVED(x)                (((x) & 0xFF) << 8)
#define BIT_ANLG_PHY_G2_ANALOG_MIPI_DSI_4LANE_DSI_RESERVEDO(x)               (((x) & 0xFF))
...
/* REG_ANLG_PHY_G2_ANALOG_MIPI_DSI_4LANE_DSI_DUMY_CTRL */

#define BIT_ANLG_PHY_G2_ANALOG_MIPI_DSI_4LANE_ANALOG_DSI_DUMY_IN(x)          (((x) & 0xFFFF) << 16)
#define BIT_ANLG_PHY_G2_ANALOG_MIPI_DSI_4LANE_ANALOG_DSI_DUMY_OUT(x)         (((x) & 0xFFFF))

/* REG_ANLG_PHY_G2_ANALOG_MIPI_DSI_4LANE_MIPI_CTRL7 */

#define BIT_ANLG_PHY_G2_ANALOG_MIPI_DSI_4LANE_DSI_TXSKEWCALHS_0              BIT(3)
#define BIT_ANLG_PHY_G2_ANALOG_MIPI_DSI_4LANE_DSI_TXSKEWCALHS_1              BIT(2)
#define BIT_ANLG_PHY_G2_ANALOG_MIPI_DSI_4LANE_DSI_TXSKEWCALHS_2              BIT(1)
#define BIT_ANLG_PHY_G2_ANALOG_MIPI_DSI_4LANE_DSI_TXSKEWCALHS_3              BIT(0)
...
#define BIT_ANLG_PHY_G2_DBG_SEL_ANALOG_MIPI_DSI_4LANE_DSI_TXULPSESC_1        BIT(19)
#define BIT_ANLG_PHY_G2_DBG_SEL_ANALOG_MIPI_DSI_4LANE_DSI_TXULPSEXIT_1       BIT(18)
#define BIT_ANLG_PHY_G2_DBG_SEL_ANALOG_MIPI_DSI_4LANE_DSI_TXREQUESTDATAHS_2  BIT(17)
#define BIT_ANLG_PHY_G2_DBG_SEL_ANALOG_MIPI_DSI_4LANE_DSI_TXREQUESTESC_2     BIT(16)
#define BIT_ANLG_PHY_G2_DBG_SEL_ANALOG_MIPI_DSI_4LANE_DSI_TXULPSESC_2        BIT(15)
#define BIT_ANLG_PHY_G2_DBG_SEL_ANALOG_MIPI_DSI_4LANE_DSI_TXULPSEXIT_2       BIT(14)
#define BIT_ANLG_PHY_G2_DBG_SEL_ANALOG_MIPI_DSI_4LANE_DSI_TXREQUESTDATAHS_3  BIT(13)
#define BIT_ANLG_PHY_G2_DBG_SEL_ANALOG_MIPI_DSI_4LANE_DSI_TXREQUESTESC_3     BIT(12)
#define BIT_ANLG_PHY_G2_DBG_SEL_ANALOG_MIPI_DSI_4LANE_DSI_TXULPSESC_3        BIT(11)
#define BIT_ANLG_PHY_G2_DBG_SEL_ANALOG_MIPI_DSI_4LANE_DSI_TXULPSEXIT_3       BIT(10)
#define BIT_ANLG_PHY_G2_DBG_SEL_ANALOG_MIPI_DSI_4LANE_DSI_TXDATAESC_0        BIT(9)
#define BIT_ANLG_PHY_G2_DBG_SEL_ANALOG_MIPI_DSI_4LANE_DSI_PS_PD_S            BIT(8)
#define BIT_ANLG_PHY_G2_DBG_SEL_ANALOG_MIPI_DSI_4LANE_DSI_PS_PD_L            BIT(7)
#define BIT_ANLG_PHY_G2_DBG_SEL_ANALOG_MIPI_DSI_4LANE_DSI_SHUTDOWNZ          BIT(6)
#define BIT_ANLG_PHY_G2_DBG_SEL_ANALOG_MIPI_DSI_4LANE_DSI_RSTZ               BIT(5)
#define BIT_ANLG_PHY_G2_DBG_SEL_ANALOG_MIPI_DSI_4LANE_DSI_ENABLE_0           BIT(4)
#define BIT_ANLG_PHY_G2_DBG_SEL_ANALOG_MIPI_DSI_4LANE_DSI_ENABLE_1           BIT(3)
#define BIT_ANLG_PHY_G2_DBG_SEL_ANALOG_MIPI_DSI_4LANE_DSI_ENABLE_2           BIT(2)
#define BIT_ANLG_PHY_G2_DBG_SEL_ANALOG_MIPI_DSI_4LANE_DSI_ENABLE_3           BIT(1)
#define BIT_ANLG_PHY_G2_DBG_SEL_ANALOG_MIPI_DSI_4LANE_DSI_ENABLECLK          BIT(0)

/* REG_ANLG_PHY_G2_ANALOG_MIPI_DSI_4LANE_REG_SEL_CFG_1 */

#define BIT_ANLG_PHY_G2_DBG_SEL_ANALOG_MIPI_DSI_4LANE_DSI_FORCEPLL           BIT(9)
#define BIT_ANLG_PHY_G2_DBG_SEL_ANALOG_MIPI_DSI_4LANE_DSI_TESTDIN            BIT(8)
#define BIT_ANLG_PHY_G2_DBG_SEL_ANALOG_MIPI_DSI_4LANE_DSI_TESTEN             BIT(7)
#define BIT_ANLG_PHY_G2_DBG_SEL_ANALOG_MIPI_DSI_4LANE_DSI_TESTCLK            BIT(6)
#define BIT_ANLG_PHY_G2_DBG_SEL_ANALOG_MIPI_DSI_4LANE_DSI_TESTCLR            BIT(5)
#define BIT_ANLG_PHY_G2_DBG_SEL_ANALOG_MIPI_DSI_4LANE_DSI_TURNREQUEST_0      BIT(4)
#define BIT_ANLG_PHY_G2_DBG_SEL_ANALOG_MIPI_DSI_4LANE_DSI_TXSKEWCALHS_0      BIT(3)
#define BIT_ANLG_PHY_G2_DBG_SEL_ANALOG_MIPI_DSI_4LANE_DSI_TXSKEWCALHS_1      BIT(2)
#define BIT_ANLG_PHY_G2_DBG_SEL_ANALOG_MIPI_DSI_4LANE_DSI_TXSKEWCALHS_2      BIT(1)
#define BIT_ANLG_PHY_G2_DBG_SEL_ANALOG_MIPI_DSI_4LANE_DSI_TXSKEWCALHS_3      BIT(0)
