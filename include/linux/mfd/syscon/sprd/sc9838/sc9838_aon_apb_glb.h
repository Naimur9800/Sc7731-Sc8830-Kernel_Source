...
#define REG_AON_APB_PLD_ID_0                         0x00E0
#define REG_AON_APB_PLD_ID_1                         0x00E4
#define REG_AON_APB_PROJ_ID_0                        0x00E8
#define REG_AON_APB_PROJ_ID_1                        0x00EC
#define REG_AON_APB_DERIVED_ID                       0x00F4
#define REG_AON_APB_MANU_ID                          0x00F8
#define REG_AON_APB_IMP_ID                           0x00FC
...
#define REG_AON_APB_OSC_CTRL                         0x0134
#define REG_AON_APB_OSC_OBS                          0x0138
#define REG_AON_APB_APCPU_SDISABLE                   0x013C
#define REG_AON_APB_MPLL0_CFG1                       0x0140
#define REG_AON_APB_MPLL0_CFG2                       0x0144
#define REG_AON_APB_GPLL_CFG1                        0x0148
#define REG_AON_APB_GPLL_CFG2                        0x014C
#define REG_AON_APB_UPLL_CFG1                        0x0150
#define REG_AON_APB_UPLL_CFG2                        0x0154
#define REG_AON_APB_APCPU_CCI_CKG_CFG                0x0158
#define REG_AON_APB_AP_MODULE_FOLLOW_CTRL            0x015C
#define REG_AON_APB_AVS_SOFT_RST                     0x0160
#define REG_AON_APB_AP_IRAM_REMAP                    0x0164
#define REG_AON_APB_APCPU_BIG_SOFT_RST               0x0168
#define REG_AON_APB_APCPU_LIT_SOFT_RST               0x016C
#define REG_AON_APB_APCPU_TOP_SOFT_RST               0x0170
#define REG_AON_APB_CA5_BIG_THM_CTRL                 0x01A0
#define REG_AON_APB_CA5_LIT_THM_CTRL                 0x01A4
#define REG_AON_APB_A53_BIGCORE_VDROP_SNSR_CTRL      0x01A8
#define REG_AON_APB_A53_LITCORE_VDROP_SNSR_CTRL      0x01AC
#define REG_AON_APB_A53_AUTO_REG_SAVE_CRTL           0x01B0
#define REG_AON_APB_CSSYS_CFG                        0x01B4
#define REG_AON_APB_REDUN_CFG                        0x01B8
...
#define REG_AON_APB_APCPU_RST_MONITOR                0x3038
...
#define REG_AON_APB_PROT_BUS_SECURE_EN               0x3080
#define REG_AON_APB_PROT_ARM7_SPACE_EN               0x3084
...
#define BIT_AON_APB_APCPU_DAP_EB                     BIT(30)
#define BIT_AON_APB_APCPU_TS1_EB                     BIT(29)
#define BIT_AON_APB_APCPU_TS0_EB                     BIT(28)
...
#define BIT_AON_APB_CODEC_EB                         BIT(31)
#define BIT_AON_APB_CSSYS_EB                         BIT(30)
#define BIT_AON_APB_CA53_LIT_AVS_EB                  BIT(29)
#define BIT_AON_APB_CA53_BIG_AVS_EB                  BIT(28)
...
#define BIT_AON_APB_CCI_EB                           BIT(7)
#define BIT_AON_APB_GPU_AVS_EB                       BIT(6)
...
#define BIT_AON_APB_APCPU_TS1_SOFT_RST               BIT(29)
#define BIT_AON_APB_APCPU_TS0_SOFT_RST               BIT(28)
...
#define BIT_AON_APB_CA53_BIG_THMA_RTC_EB             BIT(20)
...
#define BIT_AON_APB_CA53_LIT_THMA_RTC_EB             BIT(11)
...
#define BIT_AON_APB_APCPU_TS1_STOP                   BIT(9)
#define BIT_AON_APB_APCPU_TS0_STOP                   BIT(8)
...
#define BIT_AON_APB_AON_ETM_PIN_SEL                  BIT(3)
...
#define BIT_AON_APB_GPLL_SOFT_CNT_DONE               BIT(6)
#define BIT_AON_APB_MPLL_SOFT_CNT_DONE               BIT(5)
...
/*---------------------------------------------------------------------------
** Register Name   : REG_AON_APB_PLD_ID_0
** Register Offset : 0x00E0
** Description     : PLD_ID_0
---------------------------------------------------------------------------*/

#define BIT_AON_APB_PLD_ID_0(x)                     (((x) & 0xFFFFFFFF))

/*---------------------------------------------------------------------------
** Register Name   : REG_AON_APB_PLD_ID_1
** Register Offset : 0x00E4
** Description     : PLD_ID_1
---------------------------------------------------------------------------*/

#define BIT_AON_APB_PLD_ID_1(x)                     (((x) & 0xFFFFFFFF))

/*---------------------------------------------------------------------------
** Register Name   : REG_AON_APB_PROJ_ID_0
** Register Offset : 0x00E8
** Description     : PROJ_ID_0
---------------------------------------------------------------------------*/

#define BIT_AON_APB_PROJ_ID_0(x)                    (((x) & 0xFFFFFFFF))

/*---------------------------------------------------------------------------
** Register Name   : REG_AON_APB_PROJ_ID_1
** Register Offset : 0x00EC
** Description     : PROJ_ID_1
---------------------------------------------------------------------------*/

#define BIT_AON_APB_PROJ_ID_1(x)                    (((x) & 0xFFFFFFFF))

/*---------------------------------------------------------------------------
** Register Name   : REG_AON_APB_DERIVED_ID
** Register Offset : 0x00F4
** Description     : DERIVED_ID
---------------------------------------------------------------------------*/

#define BIT_AON_APB_DERIVED_ID(x)                   (((x) & 0xFF) << 8)
#define BIT_AON_APB_MF_ID(x)                        (((x) & 0xFF))

/*---------------------------------------------------------------------------
** Register Name   : REG_AON_APB_MANU_ID
** Register Offset : 0x00F8
** Description     : MANU_ID
---------------------------------------------------------------------------*/

#define BIT_AON_APB_PROCESS_ID(x)                   (((x) & 0xFF) << 8)
#define BIT_AON_APB_FOUNDRY_ID(x)                   (((x) & 0xFF))

/*---------------------------------------------------------------------------
** Register Name   : REG_AON_APB_IMP_ID
** Register Offset : 0x00FC
** Description     : IMP_ID
---------------------------------------------------------------------------*/

#define BIT_AON_APB_MEM_CMP(x)                      (((x) & 0xFF) << 8)
#define BIT_AON_APB_STD_CELL(x)                     (((x) & 0xFF))
...
#define BIT_AON_APB_DJTAG_CODEC_SEL                 BIT(7)
...
#define BIT_AON_APB_APCPU_EMC_AUTO_GATE_EN          BIT(0)
...
#define BIT_AON_APB_CODEC_DJTAG_SOFT_RST            BIT(7)
...
/*---------------------------------------------------------------------------
** Register Name   : REG_AON_APB_OSC_CTRL
** Register Offset : 0x0134
** Description     :
---------------------------------------------------------------------------*/

#define BIT_AON_APB_OSC_CTRL_SEL(x)                 (((x) & 0xF) << 16)
#define BIT_AON_APB_OSC_CTRL_EN                     BIT(15)
#define BIT_AON_APB_OSC_CTRL_START                  BIT(14)
#define BIT_AON_APB_OSC_CTRL_RSTN                   BIT(13)
#define BIT_AON_APB_OSC_CTRL_CLK_NUM(x)             (((x) & 0x1FFF))

/*---------------------------------------------------------------------------
** Register Name   : REG_AON_APB_OSC_OBS
** Register Offset : 0x0138
** Description     :
---------------------------------------------------------------------------*/

#define BIT_AON_APB_OSC_OBS_OVERFLOW                BIT(15)
#define BIT_AON_APB_OSC_OBS_SPEED_CNT(x)            (((x) & 0x7FFF))

/*---------------------------------------------------------------------------
** Register Name   : REG_AON_APB_APCPU_SDISABLE
** Register Offset : 0x013C
** Description     :
---------------------------------------------------------------------------*/

#define BIT_AON_APB_APCPU_BIG_CP15SDISABLE(x)       (((x) & 0xF) << 8)
#define BIT_AON_APB_APCPU_CFGSDISABLE               BIT(4)
#define BIT_AON_APB_APCPU_LIT_CP15SDISABLE(x)       (((x) & 0xF))

/*---------------------------------------------------------------------------
** Register Name   : REG_AON_APB_MPLL0_CFG1
** Register Offset : 0x0140
** Description     :
---------------------------------------------------------------------------*/

#define BIT_AON_APB_MPLL0_RES(x)                    (((x) & 0x7) << 28)
#define BIT_AON_APB_MPLL0_LOCK_DONE                 BIT(27)
#define BIT_AON_APB_MPLL0_DIV_S                     BIT(26)
#define BIT_AON_APB_MPLL0_MOD_EN                    BIT(25)
#define BIT_AON_APB_MPLL0_SDM_EN                    BIT(24)
#define BIT_AON_APB_MPLL0_LPF(x)                    (((x) & 0x7) << 20)
#define BIT_AON_APB_MPLL0_REFIN(x)                  (((x) & 0x3) << 18)
#define BIT_AON_APB_MPLL0_IBIAS(x)                  (((x) & 0x3) << 16)
#define BIT_AON_APB_MPLL0_N(x)                      (((x) & 0x7FF))

/*---------------------------------------------------------------------------
** Register Name   : REG_AON_APB_MPLL0_CFG2
** Register Offset : 0x0144
** Description     :
---------------------------------------------------------------------------*/

#define BIT_AON_APB_MPLL0_NINT(x)                   (((x) & 0x3F) << 24)
#define BIT_AON_APB_MPLL0_KINT(x)                   (((x) & 0xFFFFF))
...
#define BIT_AON_APB_GPLL_RES(x)                      (((x) & 0x7) << 28)
#define BIT_AON_APB_GPLL_LOCK_DONE                   BIT(27)
#define BIT_AON_APB_GPLL_DIV_S                       BIT(26)
#define BIT_AON_APB_GPLL_MOD_EN                      BIT(25)
#define BIT_AON_APB_GPLL_SDM_EN                      BIT(24)
#define BIT_AON_APB_GPLL_LPF(x)                      (((x) & 0x7) << 20)
#define BIT_AON_APB_GPLL_REFIN(x)                    (((x) & 0x3) << 18)
#define BIT_AON_APB_GPLL_IBIAS(x)                    (((x) & 0x3) << 16)
...
#define BIT_AON_APB_GPLL_NINT(x)                     (((x) & 0x3F) << 24)
#define BIT_AON_APB_GPLL_KINT(x)                     (((x) & 0xFFFFF))

/*---------------------------------------------------------------------------
** Register Name   : REG_AON_APB_UPLL_CFG1
** Register Offset : 0x0150
** Description     :
---------------------------------------------------------------------------*/

#define BIT_AON_APB_UPLL_RES(x)                      (((x) & 0x7) << 28)
#define BIT_AON_APB_UPLL_LOCK_DONE                   BIT(27)
#define BIT_AON_APB_UPLL_DIV_S                       BIT(26)
#define BIT_AON_APB_UPLL_MOD_EN                      BIT(25)
#define BIT_AON_APB_UPLL_SDM_EN                      BIT(24)
#define BIT_AON_APB_UPLL_LPF(x)                      (((x) & 0x7) << 20)
#define BIT_AON_APB_UPLL_REFIN(x)                    (((x) & 0x3) << 18)
#define BIT_AON_APB_UPLL_IBIAS(x)                    (((x) & 0x3) << 16)
#define BIT_AON_APB_UPLL_N(x)                        (((x) & 0x7FF))

/*---------------------------------------------------------------------------
** Register Name   : REG_AON_APB_UPLL_CFG2
** Register Offset : 0x0154
** Description     :
---------------------------------------------------------------------------*/

#define BIT_AON_APB_UPLL_NINT(x)                     (((x) & 0x3F) << 24)
#define BIT_AON_APB_UPLL_KINT(x)                     (((x) & 0xFFFFF))

/*---------------------------------------------------------------------------
** Register Name   : REG_AON_APB_APCPU_CCI_CKG_CFG
** Register Offset : 0x0158
** Description     :
---------------------------------------------------------------------------*/

#define BIT_AON_APB_APCPU_CCI_CKG_EN                 BIT(1)
#define BIT_AON_APB_APCPU_CCI_AUTO_GATE_EN           BIT(0)

/*---------------------------------------------------------------------------
** Register Name   : REG_AON_APB_AP_MODULE_FOLLOW_CTRL
** Register Offset : 0x015C
** Description     :
---------------------------------------------------------------------------*/

#define BIT_AON_APB_AP_GPU_CLK_FOLLOW_AP             BIT(2)
#define BIT_AON_APB_AP_MM_CODEC_CLK_FOLLOW_AP        BIT(1)
#define BIT_AON_APB_AP_MM_CLK_FOLLOW_AP              BIT(0)

/*---------------------------------------------------------------------------
** Register Name   : REG_AON_APB_AVS_SOFT_RST
** Register Offset : 0x0160
** Description     :
---------------------------------------------------------------------------*/

#define BIT_AON_APB_CA53_LIT_AVS_SOFT_RST            BIT(2)
#define BIT_AON_APB_CA53_BIG_AVS_SOFT_RST            BIT(1)
#define BIT_AON_APB_GPU_AVS_SOFT_RST                 BIT(0)

/*---------------------------------------------------------------------------
** Register Name   : REG_AON_APB_AP_IRAM_REMAP
** Register Offset : 0x0164
** Description     :
---------------------------------------------------------------------------*/

#define BIT_AON_APB_AP_IRAM_REMAP                    BIT(0)

/*---------------------------------------------------------------------------
** Register Name   : REG_AON_APB_APCPU_BIG_SOFT_RST
** Register Offset : 0x0168
** Description     :
---------------------------------------------------------------------------*/

#define BIT_AON_APB_APCPU_BIG_DBG_SOFT_RST           BIT(9)
#define BIT_AON_APB_APCPU_BIG_L2_SOFT_RST            BIT(8)
#define BIT_AON_APB_APCPU_BIG_ATB_SOFT_RST(x)        (((x) & 0xF) << 4)
#define BIT_AON_APB_APCPU_BIG_CORE_SOFT_RST(x)       (((x) & 0xF))

/*---------------------------------------------------------------------------
** Register Name   : REG_AON_APB_APCPU_LIT_SOFT_RST
** Register Offset : 0x016C
** Description     :
---------------------------------------------------------------------------*/

#define BIT_AON_APB_APCPU_LIT_DBG_SOFT_RST           BIT(9)
#define BIT_AON_APB_APCPU_LIT_L2_SOFT_RST            BIT(8)
#define BIT_AON_APB_APCPU_LIT_ATB_SOFT_RST(x)        (((x) & 0xF) << 4)
#define BIT_AON_APB_APCPU_LIT_CORE_SOFT_RST(x)       (((x) & 0xF))

/*---------------------------------------------------------------------------
** Register Name   : REG_AON_APB_APCPU_TOP_SOFT_RST
** Register Offset : 0x0170
** Description     :
---------------------------------------------------------------------------*/

#define BIT_AON_APB_APCPU_MTX_SOFT_RST               BIT(2)
#define BIT_AON_APB_APCPU_EMC_SOFT_RST               BIT(1)
#define BIT_AON_APB_APCPU_DAP_SOFT_RST               BIT(0)

/*---------------------------------------------------------------------------
** Register Name   : REG_AON_APB_CA5_BIG_THM_CTRL
** Register Offset : 0x01A0
** Description     :
---------------------------------------------------------------------------*/

#define BIT_AON_APB_CA53_BIG_THM_CALI_RSVD(x)        (((x) & 0xFF))

/*---------------------------------------------------------------------------
** Register Name   : REG_AON_APB_CA5_LIT_THM_CTRL
** Register Offset : 0x01A4
** Description     :
---------------------------------------------------------------------------*/

#define BIT_AON_APB_CA53_LIT_THM_CALI_RSVD(x)        (((x) & 0xFF))

/*---------------------------------------------------------------------------
** Register Name   : REG_AON_APB_A53_BIGCORE_VDROP_SNSR_CTRL
** Register Offset : 0x01A8
** Description     :
---------------------------------------------------------------------------*/

#define BIT_AON_APB_CA53_BIG_VDROP1_RESERVED_CTRL(x)  (((x) & 0xF) << 24)
#define BIT_AON_APB_CA53_BIG_VDROP1_CTRL(x)           (((x) & 0x3) << 22)
#define BIT_AON_APB_CA53_BIG_VDROP1_CURRENT_CTRL(x)   (((x) & 0x3) << 20)
#define BIT_AON_APB_CA53_BIG_VDROP1_OUT               BIT(17)
#define BIT_AON_APB_CA53_BIG_VDROP1_EN                BIT(16)
#define BIT_AON_APB_CA53_BIG_VDROP0_RESERVED_CTRL(x)  (((x) & 0xF) << 8)
#define BIT_AON_APB_CA53_BIG_VDROP0_CTRL(x)           (((x) & 0x3) << 6)
#define BIT_AON_APB_CA53_BIG_VDROP0_CURRENT_CTRL(x)   (((x) & 0x3) << 4)
#define BIT_AON_APB_CA53_BIG_VDROP0_OUT               BIT(1)
#define BIT_AON_APB_CA53_BIG_VDROP0_EN                BIT(0)

/*---------------------------------------------------------------------------
** Register Name   : REG_AON_APB_A53_LITCORE_VDROP_SNSR_CTRL
** Register Offset : 0x01AC
** Description     :
---------------------------------------------------------------------------*/

#define BIT_AON_APB_CA53_LIT_VDROP1_RESERVED_CTRL(x)  (((x) & 0xF) << 24)
#define BIT_AON_APB_CA53_LIT_VDROP1_CTRL(x)           (((x) & 0x3) << 22)
#define BIT_AON_APB_CA53_LIT_VDROP1_CURRENT_CTRL(x)   (((x) & 0x3) << 20)
#define BIT_AON_APB_CA53_LIT_VDROP1_OUT               BIT(17)
#define BIT_AON_APB_CA53_LIT_VDROP1_EN                BIT(16)
#define BIT_AON_APB_CA53_LIT_VDROP0_RESERVED_CTRL(x)  (((x) & 0xF) << 8)
#define BIT_AON_APB_CA53_LIT_VDROP0_CTRL(x)           (((x) & 0x3) << 6)
#define BIT_AON_APB_CA53_LIT_VDROP0_CURRENT_CTRL(x)   (((x) & 0x3) << 4)
#define BIT_AON_APB_CA53_LIT_VDROP0_OUT               BIT(1)
#define BIT_AON_APB_CA53_LIT_VDROP0_EN                BIT(0)

/*---------------------------------------------------------------------------
** Register Name   : REG_AON_APB_A53_AUTO_REG_SAVE_CRTL
** Register Offset : 0x01B0
** Description     :
---------------------------------------------------------------------------*/

#define BIT_AON_APB_APCPU_AUTO_REG_SAVE_TRIG_SEL      BIT(1)
#define BIT_AON_APB_AUTO_REG_SAVE_EN                  BIT(0)
...
#define BIT_AON_APB_CSSYS_TPIU_TPCTL                  BIT(0)

/*---------------------------------------------------------------------------
** Register Name   : REG_AON_APB_REDUN_CFG
** Register Offset : 0x01B8
** Description     :
---------------------------------------------------------------------------*/

#define BIT_AON_APB_REDUN_CFG_3                       BIT(3)
#define BIT_AON_APB_REDUN_CFG_2                       BIT(2)
#define BIT_AON_APB_REDUN_CFG_1                       BIT(1)
#define BIT_AON_APB_REDUN_CFG_0                       BIT(0)
...
/*---------------------------------------------------------------------------
** Register Name   : REG_AON_APB_APCPU_RST_MONITOR
** Register Offset : 0x3038
** Description     :
---------------------------------------------------------------------------*/

#define BIT_AON_APB_APCPU_RST_MONITOR(x)             (((x) & 0xFFFFFFFF))
...
/*---------------------------------------------------------------------------
** Register Name   : REG_AON_APB_PROT_BUS_SECURE_EN
** Register Offset : 0x3080
** Description     :
---------------------------------------------------------------------------*/

#define BIT_AON_APB_BUS_SECURE_EN             BIT(0)

/*---------------------------------------------------------------------------
** Register Name   : REG_AON_APB_PROT_ARM7_SPACE_EN
** Register Offset : 0x3084
** Description     :
---------------------------------------------------------------------------*/

#define BIT_AON_APB_ARM7_SPACE_EN             BIT(0)
