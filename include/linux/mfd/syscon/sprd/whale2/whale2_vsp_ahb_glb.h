...
#ifndef _WHALE2_VSP_AHB_REG_H
#define _WHALE2_VSP_AHB_REG_H



#define REG_VSP_AHB_AHB_EB                           0x0000
#define REG_VSP_AHB_AHB_RST                          0x0004
#define REG_VSP_AHB_GEN_CKG_CFG                      0x0008
#define REG_VSP_AHB_MISC_CTRL                        0x000C
#define REG_VSP_AHB_VSP_QOS_CFG                      0x0010
