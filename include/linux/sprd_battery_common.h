...
struct sprd_battery_platform_data {
	...
	/*wdm---*/
	uint32_t chg_current_call;
	uint32_t chg_current_high_temp_area;
	uint32_t chg_current_high_temp_area_30;
        uint32_t chg_current_low_temp_area;
        uint32_t low_temp_area_h;
        uint32_t low_temp_area_l;
        uint32_t high_temp_area_h;
        uint32_t high_temp_area_l;
	uint32_t high_temp_area_l_cur;
	uint32_t high_temp_area_l_cur_30;	

        uint32_t chg_end_vol_high_temp;
        uint32_t chg_end_to_chg_state_vol;
        uint32_t chg_max_cur;
	/*---*/
	...
	/*wdm---*/
	int discharging_rint;           /*battery internal impedance on discharging*/
        int charging_rint;              /*battery internal impedance on charging*/
	//rint table
        int rint_tab_size;
        struct sprdbat_table_data *rint_tab;
	/*---*/
};
#endif
