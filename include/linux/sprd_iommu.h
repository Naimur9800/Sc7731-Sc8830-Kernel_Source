...
#define AC(X,Y)  (X##Y)
#define MMU_START_MB_ADDR(_x_)		( (AC(_x_,UL)) << 20 & (BIT(20)|BIT(21)|BIT(22)|BIT(23)|BIT(24)|BIT(25)|BIT(26)|BIT(27)|BIT(28)|BIT(29)|BIT(30)|BIT(31)) )
#define MMU_RAMCLK_DIV2_EN(_x_)		( (AC(_x_,UL)) << 2 & (BIT(2)) )
