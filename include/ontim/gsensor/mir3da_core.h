...
#define CORE_VER                            "2.0.0_2014-11-18-10:19:30_"CUST_VER
...
#define MIR3DA_OFFSET_TEMP_SOLUTION         1//   1
#if MIR3DA_OFFSET_TEMP_SOLUTION
#define MIR3DA_AUTO_CALIBRATE               0 //1 default:close auto calibration.
#else
#define MIR3DA_AUTO_CALIBRATE               0
#endif /* !MIR3DA_OFFSET_TEMP_SOLUTION */
#if MIR3DA_AUTO_CALIBRATE
#define MIR3DA_SUPPORT_ATA_TEST             0//1 default:close ATA support
#endif 
...
struct mir3da_platform_data{
    int (*power_on)(int on);
    unsigned char direction_placement ;
};
