...
static struct touchpanel_wakeup_event_data msg2xxx_wakeup_array[]=
{
    {
        .wakeup_event = 0x01,
        .key_code = KEY_POWER,
...
static unsigned char msg2238_fw_ofilm[]={
	#include <ontim/touchscreen/msg21xxA/msg2238_A1000_ofilm.i>
};
static unsigned char msg2238_fw_holit[]={
	#include <ontim/touchscreen/msg21xxA/msg2238_A1000_holit.i>
};

static unsigned char msg2238_fw_shenyue[]={
	#include <ontim/touchscreen/msg21xxA/msg2238_A1000_shenyue.i>
};
...
{
	{
		...
		//.wakeup_event=msg2xxx_wakeup_array, 
		//.wakeup_event_num=ARRAY_SIZE(msg2xxx_wakeup_array),
	    .major_version = 0x01 ,
		.vendor_id = 0x01,
		.product_name="A1000",
		.panel_fw = msg2238_fw_ofilm,
		.panel_fw_size = sizeof(msg2238_fw_ofilm),
		.vendor_name="OFILM-MSG2238",
	},
	{
		.points = 2,
		.x_max_res = 480,
		...
		.vendor_id = 0x10,
		.product_name="A1000",
		.panel_fw = msg2238_fw_holit,
		.panel_fw_size = sizeof(msg2238_fw_holit),
		.vendor_name="HOLIT-MSG2238",
	},
	{
		.points = 2,
		.x_max_res = 480,
		...
		.vendor_id = 0x05,
		.product_name="A1000",
		.panel_fw = msg2238_fw_shenyue,
		.panel_fw_size = sizeof(msg2238_fw_shenyue),
		.vendor_name="SHENYUE-MSG2238",
	},
};
...
static struct mc3xxx_platform_data mc3xxx_plat_data = {
	.power_on = sensor_set_power,
	.current_placement = MC3XXX_TOP_RIGHT_UP,
};
#endif
