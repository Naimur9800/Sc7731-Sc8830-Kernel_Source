...
static int compr_send_cmd_no_wait(uint16_t channel, uint32_t cmd,
	uint32_t total_size, void *reserve)
{
...
static int compr_receive_cmd(uint16_t channel, uint32_t cmd, int *value)
{
